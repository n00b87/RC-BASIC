...
#include <SDL2/SDL.h>
#include <ctype.h>
#include "rc_array_lib.h"

using namespace std;

const unsigned int RC_DATA_SEGMENT_SWITCH = 0;
const unsigned int RC_CODE_SEGMENT_SWITCH = 1;
...
//vector <string> rc_id(10000);
rc_string_array rc_id;
//string rc_tmp_id[99];
...
uint64_t wcon_count[256];
string wcon_code[256][256];
...
int src_line_num = 1;
//vector <int> end_of_line(20000);
int end_of_line[50000];
...
uint64_t nid_byref_index[30000];
uint64_t sid_byref_index[30000];
...
int rc_isBuiltIn_ID(string s_id, int arg_count, int tmp_index)
{
    if(s_id.compare("PROGRAM.FPRINT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 0");
    ...
    else if(s_id.compare("PROGRAM.INPUT$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 1");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ARRAYDIM")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 3");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ARRAYSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 4");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ASC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 5");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CHR$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 6");
        return 1;
    }
    else if(s_id.compare("PROGRAM.INSERT$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 7");
        return 1;
    }
    else if(s_id.compare("PROGRAM.INSTR")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 8");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LCASE$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 9");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LEFT$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 10");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LENGTH")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 11");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LTRIM$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 12");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MID$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 13");
        return 1;
    }
    else if(s_id.compare("PROGRAM.REPLACE$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 14");
        return 1;
    }
    else if(s_id.compare("PROGRAM.REPLACESUBSTR$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 15");
        return 1;
    }
    else if(s_id.compare("PROGRAM.REVERSE$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 16");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RIGHT$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 17");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RTRIM$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 18");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FILLSTRING$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 19");
        return 1;
    }
    else if(s_id.compare("PROGRAM.STR$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 20");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TALLY")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 21");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TRIM$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 22");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UCASE$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 23");
        return 1;
    }
    else if(s_id.compare("PROGRAM.VAL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 24");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ABS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 25");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ACOS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 26");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ANDBIT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 27");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ASIN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 28");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ATAN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 29");
        return 1;
    }
    else if(s_id.compare("PROGRAM.BIN$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 30");
        return 1;
    }
    else if(s_id.compare("PROGRAM.COS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 31");
        return 1;
    }
    else if(s_id.compare("PROGRAM.EXP")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 32");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FRAC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 33");
        return 1;
    }
    else if(s_id.compare("PROGRAM.HEX$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 34");
        return 1;
    }
    else if(s_id.compare("PROGRAM.INT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 35");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOG")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 36");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MAX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 37");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MIN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 38");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ORBIT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 39");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RANDOMIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 40");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RAND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 41");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ROUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 42");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SIGN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 43");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SIN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 44");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SQRT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 45");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TAN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 46");
        return 1;
    }
    else if(s_id.compare("PROGRAM.XORBIT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 47");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FILEOPEN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 48");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FILECLOSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 49");
        return 1;
    }
    else if(s_id.compare("PROGRAM.READBYTE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 50");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WRITEBYTE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 51");
        return 1;
    }
    else if(s_id.compare("PROGRAM.READLINE$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 52");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WRITELINE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 53");
        return 1;
    }
    else if(s_id.compare("PROGRAM.COPYFILE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 54");
        return 1;
    }
    else if(s_id.compare("PROGRAM.REMOVEFILE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 55");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FILEEXISTS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 56");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MOVEFILE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 57");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RENAMEFILE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 58");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FILELENGTH")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 59");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TELL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 60");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SEEK")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 61");
        return 1;
    }
    else if(s_id.compare("PROGRAM.EOF")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 62");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FREEFILE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 63");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CHANGEDIR")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 64");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DIREXISTS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 65");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DIRFIRST$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 66");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DIR$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 67");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DIRNEXT$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 68");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MAKEDIR")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 69");
        return 1;
    }
    else if(s_id.compare("PROGRAM.REMOVEDIR")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 70");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DATE$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 71");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TICKS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 72");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TIME$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 73");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TIMER")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 74");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WAIT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 75");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWOPEN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 76");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWCLOSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 77");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RAISEWINDOW")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 78");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOW")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 79");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UPDATE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 80");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SHOWWINDOW")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 81");
        return 1;
    }
    else if(s_id.compare("PROGRAM.HIDEWINDOW")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 82");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETWINDOWTITLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 83");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWTITLE$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 84");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETWINDOWPOSITION")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 85");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETWINDOWPOSITION")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 86");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETWINDOWSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 87");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETWINDOWSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 88");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETWINDOWMINSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 89");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETWINDOWMINSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 90");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETWINDOWMAXSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 91");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETWINDOWMAXSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 92");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWISFULLSCREEN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 93");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWISVISIBLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 94");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWISBORDERED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 95");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWISRESIZABLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 96");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWISMINIMIZED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 97");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWISMAXIMIZED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 98");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETWINDOWFULLSCREEN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 99");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MAXIMIZEWINDOW")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 100");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MINIMIZEWINDOW")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 101");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETWINDOWBORDER")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 102");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CANVASOPEN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 104");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CANVASCLOSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 105");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETCANVASVISIBLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 240");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CANVASISVISIBLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 241");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETCANVASVIEWPORT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 106");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETCANVASVIEWPORT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 107");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CANVAS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 108");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETCANVASOFFSET")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 109");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETCANVASOFFSET")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 110");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETCANVASSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 111");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CLEARCANVAS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 112");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETCANVASALPHA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 113");
        return 1;
    }
    else if(s_id.compare("PROGRAM.COPYCANVAS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 114");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CLONECANVAS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 115");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETCANVASZ")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 116");
        return 1;
    }
    else if(s_id.compare("PROGRAM.BOX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 117");
        return 1;
    }
    else if(s_id.compare("PROGRAM.BOXFILL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 118");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CIRCLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 119");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CIRCLEFILL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 120");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ELLIPSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 121");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ELLIPSEFILL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 122");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PIXEL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 123");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETCOLOR")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 124");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LINE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 125");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FLOODFILL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 126");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RGB")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 127");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RGBA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 128");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PSET")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 129");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CREATEIMAGE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 242");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CREATEIMAGE_EX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 243");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOADIMAGE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 130");
        return 1;
    }
    else if(s_id.compare("PROGRAM.COLORKEY")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 131");
        return 1;
    }
    else if(s_id.compare("PROGRAM.COPYIMAGE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 132");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DELETEIMAGE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 133");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETIMAGEALPHA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 134");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETIMAGEALPHA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 146");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETIMAGESIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 135");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FLIPIMAGE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 136");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 137");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_BLIT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 144");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_ROTATE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 138");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_ROTATE_EX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 139");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_ZOOM")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 140");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_ZOOM_EX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 141");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_ROTOZOOM")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 142");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_ROTOZOOM_EX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 143");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWIMAGE_BLIT_EX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 145");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETCURSOR")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 160");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PRINTS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 163");
        return 1;
    }
    else if(s_id.compare("PROGRAM.INPUTS$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 164");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOCATE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 165");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FONTISLOADED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 244");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FONT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 245");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOADFONT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 246");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DELETEFONT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 247");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETFONTSTYLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 248");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWTEXT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 168");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWTEXT_SHADED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 249");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DRAWTEXT_BLENDED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 250");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETTEXTSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 251");
        return 1;
    }
    else if(s_id.compare("PROGRAM.INKEY")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 169");
        return 1;
    }
    else if(s_id.compare("PROGRAM.KEY")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 170");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WAITKEY")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 171");
        return 1;
    }
    else if(s_id.compare("PROGRAM.HIDEMOUSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 172");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SHOWMOUSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 173");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MOUSEISVISIBLE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 174");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETMOUSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 175");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETMOUSEWHEEL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 176");
        return 1;
    }
    else if(s_id.compare("PROGRAM.IMAGEEXISTS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 177");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMJOYSTICKS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 178");
        return 1;
    }
    else if(s_id.compare("PROGRAM.JOYAXIS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 179");
        return 1;
    }
    else if(s_id.compare("PROGRAM.JOYBUTTON")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 180");
        return 1;
    }
    else if(s_id.compare("PROGRAM.JOYNAME$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 181");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOADSOUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 182");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOADMUSIC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 183");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PLAYSOUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 184");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PLAYSOUNDTIMED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 185");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PLAYMUSIC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 186");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PAUSESOUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 187");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RESUMESOUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 188");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PAUSEMUSIC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 189");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RESUMEMUSIC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 190");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DELETESOUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 191");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FADEMUSICIN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 192");
        return 1;
    }
    else if(s_id.compare("PROGRAM.FADEMUSICOUT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 193");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MUSICEXISTS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 194");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETMUSICVOLUME")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 195");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MUSICVOLUME")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 196");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETMUSICPOSITION")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 197");
        return 1;
    }
    else if(s_id.compare("PROGRAM.MUSICPOSITION")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 198");
        return 1;
    }
    else if(s_id.compare("PROGRAM.REWINDMUSIC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 199");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETSOUNDCHANNELS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 200");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMSOUNDCHANNELS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 252");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SOUNDISENABLED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 201");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SOUNDEXISTS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 202");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETCHANNELVOLUME")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 203");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CHANNELVOLUME")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 204");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETSOUNDVOLUME")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 205");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SOUNDVOLUME")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 206");
        return 1;
    }
    else if(s_id.compare("PROGRAM.STOPMUSIC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 207");
        return 1;
    }
    else if(s_id.compare("PROGRAM.STOPSOUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 208");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TCP_SOCKETOPEN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 209");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TCP_SOCKETCLOSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 210");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TCP_REMOTEHOST")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 211");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TCP_REMOTEPORT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 212");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TCP_GETDATA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 213");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TCP_SENDDATA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 214");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TCP_ACCEPTSOCKET")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 215");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_SOCKETOPEN")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 216");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_GETDATA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 217");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_LENGTH")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 219");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_MAXLENGTH")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 222");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_REMOTEHOST$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 223");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_REMOTEPORT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 224");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_SOCKETCLOSE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 225");
        return 1;
    }
    else if(s_id.compare("PROGRAM.UDP_SENDDATA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 226");
        return 1;
    }
    else if(s_id.compare("PROGRAM.TOUCHPRESSURE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 227");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETTOUCH")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 228");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETMULTITOUCH")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 229");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ZONEINPUT$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 230");
        return 1;
    }
    else if(s_id.compare("PROGRAM.READINPUT_START")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 233");
        return 1;
    }
    else if(s_id.compare("PROGRAM.READINPUT_STOP")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 234");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CANVASCLIP")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 235");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWCLIP")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 236");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RENDERTEXT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 237");
        return 1;
    }
    else if(s_id.compare("PROGRAM.READINPUT_TEXT$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 238");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOCALIP$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 253");
        return 1;
    }
    else if(s_id.compare("PROGRAM.READINPUT_SETTEXT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 254");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETTOUCHFINGER")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 255");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMFINGERS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 256");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOADIMAGE_EX")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 257");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RECT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 258");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RECTFILL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 259");
        return 1;
    }
    else if(s_id.compare("PROGRAM.OS$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 260");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMJOYBUTTONS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 261");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMJOYAXES")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 262");
        return 1;
    }
    else if(s_id.compare("PROGRAM.LOADVIDEO")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 263");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PLAYVIDEO")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 264");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PAUSEVIDEO")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 265");
        return 1;
    }
    else if(s_id.compare("PROGRAM.STOPVIDEO")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 266");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETVIDEOPOSITION")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 267");
        return 1;
    }
    else if(s_id.compare("PROGRAM.RESUMEVIDEO")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 269");
        return 1;
    }
    else if(s_id.compare("PROGRAM.VIDEOPOSITION")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 270");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DELETEVIDEO")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 272");
        return 1;
    }
    else if(s_id.compare("PROGRAM.DELETEMUSIC")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 273");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SYSTEM")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 274");
        return 1;
    }
    else if(s_id.compare("PROGRAM.VIDEOISPLAYING")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 275");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ROUNDRECT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 276");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ROUNDRECTFILL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 277");
        return 1;
    }
    else if(s_id.compare("PROGRAM.VIDEOEND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 278");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETVIDEOSTATS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 279");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETVIDEODRAWRECT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 280");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETVIDEODRAWRECT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 281");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETVIDEOSIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 282");
        return 1;
    }
    else if(s_id.compare("PROGRAM.VIDEOEXISTS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 283");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETVIDEOALPHA")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 284");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CREATESOUND")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 285");
        return 1;
    }
    else if(s_id.compare("PROGRAM.COMMAND$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 286");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMCOMMANDS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 287");
        return 1;
    }
    else if(s_id.compare("PROGRAM.STR_F$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 288");
        return 1;
    }
    else if(s_id.compare("PROGRAM.STR_S$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 289");
        return 1;
    }
    else if(s_id.compare("PROGRAM.CLS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 290");
        return 1;
    }
    else if(s_id.compare("PROGRAM.ENV$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 291");
        return 1;
    }
    else if(s_id.compare("PROGRAM.SETENV")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 292");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PREFPATH$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 293");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMJOYHATS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 294");
        return 1;
    }
    else if(s_id.compare("PROGRAM.JOYHAT")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 295");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMJOYTRACKBALLS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 296");
        return 1;
    }
    else if(s_id.compare("PROGRAM.GETJOYTRACKBALL")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 297");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWHASINPUTFOCUS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 298");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWHASMOUSEFOCUS")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 299");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PUSH_N")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 300");
        return 1;
    }
    else if(s_id.compare("PROGRAM.PUSH_S")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 301");
        return 1;
    }
    else if(s_id.compare("PROGRAM.POP_N")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 302");
        return 1;
    }
    else if(s_id.compare("PROGRAM.POP_S$")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 303");
        return 1;
    }
    else if(s_id.compare("PROGRAM.N_STACK_SIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 304");
        return 1;
    }
    else if(s_id.compare("PROGRAM.S_STACK_SIZE")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 305");
        return 1;
    }
    else if(s_id.compare("PROGRAM.JOYSTICKISCONNECTED")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_index, "intern 306");
        return 1;
    }
    else if(s_id.compare("PROGRAM.NUMWINDOWS")==0)
    {
        intern_type = "#";
        //tmp[tmp_index] = "intern 307";
        rc_setStringArray(&tmp, tmp_index, "intern 307");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWEXISTS")==0)
    {
        intern_type = "#";
        //tmp[tmp_index] = "intern 308";
        rc_setStringArray(&tmp, tmp_index, "intern 308");
        return 1;
    }
    else if(s_id.compare("PROGRAM.READINPUT_TOGGLEBACKSPACE")==0)
    {
        intern_type = "#";
        //tmp[tmp_index] = "intern 309";
        rc_setStringArray(&tmp, tmp_index, "intern 309");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWEVENT_CLOSE")==0)
    {
        intern_type = "#";
        //tmp[tmp_index] = "intern 310";
        rc_setStringArray(&tmp, tmp_index, "intern 310");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWEVENT_MINIMIZE")==0)
    {
        intern_type = "#";
        //tmp[tmp_index] = "intern 311";
        rc_setStringArray(&tmp, tmp_index, "intern 311");
        return 1;
    }
    else if(s_id.compare("PROGRAM.WINDOWEVENT_MAXIMIZE")==0)
    {
        intern_type = "#";
        //tmp[tmp_index] = "intern 312";
        rc_setStringArray(&tmp, tmp_index, "intern 312");
        return 1;
    }
...
int rc_setIDType(int id_index, string id_type)
{
    int n = 0;
    string s_id = "";
    string rc_id_str = rc_getStringArrayValue(rc_id,id_index);
    for(int i = 0; i < rc_id_str.length(); i++)
    {
        ...
        else if(n == 1 && rc_id_str.substr(i,1).compare(" ")!=0)
        {
            s_id += id_type;
            string s = rc_id_str.substr(i);
            i += s.find_first_of(" ")-1;
            n++;
        }
        else
        {
            s_id += rc_id_str.substr(i,1);
        }
    }
    //rc_id[id_index] = s_id;
    rc_setStringArray(&rc_id, id_index, s_id);
...
string rc_searchID(string id)
{
    ...
    while(s_loop==0)
    {
        for(int i = 0; i < rc_id_count; i++)
        {
            ...
            rc_id_str = rc_getStringArrayValue(rc_id, i);

            if(rc_id_str.substr(0,rc_id_str.find_first_of(" ")).compare(search_scope+"."+id)==0)
            {
                search_index = i;
...
string rc_getID(int index)
{
    ...
    {
        rc_id_str = rc_getStringArrayValue(rc_id, index);
        return rc_id_str.substr(0,rc_id_str.find_first_of(" "));
    }
        ...
        if(rc_tokens[i].substr(0,4).compare("<id>")==0)
        {
            ...
            if(eid_type.compare("#F")==0 || eid_type.compare("$F")==0 || eid_type.compare("#P")==0 || eid_type.compare("$P")==0)
            {
                ...
                for(int n = eid_rc_index+1; n < rc_id_count; n++)
                {
                    ...
                    //cout << ">>" << n << endl;
                    rc_id_str = rc_getStringArrayValue(rc_id, n);
                    arg_id = rc_id_str.substr(0, rc_id_str.find_first_of(" "));
                    //cout << arg_id << "~" << endl;
    ...
    for(int i = 0; i < rc_tokens_count; i++)
    {
        if(rc_tokens[i].substr(0,8).compare("<string>")==0)
        {
            ...
            for(int j = 8; j < rc_tokens[i].length(); j++)
            {
                ...
                //RC_DATA_SEGMENT.insert(it+rc_data_offset, rc_tokens[i].substr(j,1)[0]);
                //RC_DATA_SEGMENT[rc_data_offset] = rc_tokens[i].substr(j,1)[0];
                //rc_setUCharArray(&RC_DATA_SEGMENT, rc_data_offset, rc_tokens[i].substr(j,1)[0]);
                rc_data_bin.put(rc_tokens[i].substr(j,1)[0]);
                rc_data_offset++;
            }
            //it = RC_DATA_SEGMENT.begin();
            //RC_DATA_SEGMENT.insert(it+rc_data_offset, 0);
            //RC_DATA_SEGMENT[rc_data_offset] = 0;
            //rc_setUCharArray(&RC_DATA_SEGMENT, rc_data_offset, 0);
            rc_data_bin.put(0);
            rc_data_offset++;
        ...
        else if(rc_tokens[i].substr(0,4).compare("<id>")==0)
        {
            ...
            if(id.compare("")!=0)
            {
                ...
                if(id_type.compare("$")==0)
                {
                    ...
                    rc_setStringArray(&tmp, tmp_count, "mov$ s" + rc_intToString(s_index) + " " + id);
                    tmp_count++;
                    rc_tokens[i] = "<vm_var>s" + rc_intToString(s_index);
                    s_index++;
                }
                else if(id_type.compare("#")==0)
                {
                    ...
                    rc_setStringArray(&tmp, tmp_count, "mov m" + rc_intToString(m_index) + " " + id);
                    tmp_count++;
    ...
    while(parseLoop)
    {
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            if(rc_tokens[i].substr(0,5).compare("<num>")==0)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "mov m" + rc_intToString(m_index) + " " + rc_tokens[i].substr(5));
                currentIndex++;
                rc_tokens[i] = "<vm_var>m" + rc_intToString(m_index);
                m_index++;
            }
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            ...
            if(op_flag == 2)
            {
                ...
                if(current_op == 1)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "pwr " + v1 + " " + v2);
                }
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            ...
            if(op_flag == 2)
            {
                ...
                if(current_op == 1)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "mul " + v1 + " " + v2);
                }
                else if(current_op == 2)
                {
                    //tmp[currentIndex] = "div " + v1 + " " + v2;
                    rc_setStringArray(&tmp, currentIndex, "div " + v1 + " " + v2);
                }
                else if(current_op == 3)
                {
                    //tmp[currentIndex] = "mod " + v1 + " " + v2;
                    rc_setStringArray(&tmp, currentIndex, "mod " + v1 + " " + v2);
                }
                currentIndex++;
                //cout<<tmp[currentIndex-2]<<endl;
                //cout<<tmp[currentIndex-1]<<endl;
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            ...
            if(op_flag == 2)
            {
                ...
                if(current_op == 1)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "add " + v1 + " " + v2);
                }
                else if(current_op == 2)
                {
                    //tmp[currentIndex] = "sub " + v1 + " " + v2;
                    rc_setStringArray(&tmp, currentIndex, "sub " + v1 + " " + v2);
                }
                currentIndex++;
                //cout<<tmp[currentIndex-2]<<endl;
                //cout<<tmp[currentIndex-1]<<endl;
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            ...
            if(op_flag == 2)
            {
                ...
                if(current_op == 1)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "shl " + v1 + " " + v2);
                }
                else if(current_op == 2)
                {
                    //tmp[currentIndex] = "shr " + v1 + " " + v2;
                    rc_setStringArray(&tmp, currentIndex, "shr " + v1 + " " + v2);
                }
                currentIndex++;
                //cout<<tmp[currentIndex-2]<<endl;
                //cout<<tmp[currentIndex-1]<<endl;
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            if(rc_tokens[i].substr(0,5).compare("<num>")==0)
            {
                if(op_flag == 0)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "str$ s" + rc_intToString(s_index) + " " + rc_tokens[i].substr(5));
                    currentIndex++;
            ...
            else if(rc_tokens[i].substr(0,4).compare("<id>")==0)
            {
                if(op_flag == 0)
                {
                    ...
                    if(v1_type.substr(0,1).compare("$")!=0)
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "str$ s" + rc_intToString(s_index) + " " + v1);
                        currentIndex++;
                        v1 = "s" + rc_intToString(s_index);
                        s_index++;
                    }
                    else
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "mov$ s" + rc_intToString(s_index) + " " + v1);
                        currentIndex++;
                        v1 = "s" + rc_intToString(s_index);
                        s_index++;
                    }
                ...
                else
                {
                    ...
                    if(v2_type.substr(0,1).compare("$")!=0)
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "str$ s" + rc_intToString(s_index) + " " + v2);
                        currentIndex++;
                        v2 = "s" + rc_intToString(s_index);
                        s_index++;
                    }
                    else
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "mov$ s" + rc_intToString(s_index) + " " + v2);
                        currentIndex++;
                        v2 = "s" + rc_intToString(s_index);
                        s_index++;
                    }
            ...
            else if(rc_tokens[i].substr(0,8).compare("<vm_var>")==0)
            {
                if(op_flag == 0)
                {
                    ...
                    else
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "str$ s" + rc_intToString(s_index) + " " + rc_tokens[i].substr(8));
                        currentIndex++;
                        v1 = "s" + rc_intToString(s_index);
                        s_index++;
                    }
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            ...
            if(op_flag == 2 && equal_op == 1)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "cmp " + v1 + " " + v2);
                currentIndex++;
                //tmp[currentIndex] = "mov " + v1 + " %EQUAL_FLAG";
                rc_setStringArray(&tmp, currentIndex, "mov " + v1 + " %EQUAL_FLAG");
                currentIndex++;
            ...
            else if(op_flag == 2 && equal_op == 2)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "mov " + v1 + " %GREATER_FLAG");
                currentIndex++;
            ...
            else if(op_flag == 2 && equal_op == 3)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "mov " + v1 + " %LESS_FLAG");
                currentIndex++;
            ...
            else if(op_flag == 2 && equal_op == 4)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "mov " + v1 + " %GREATER_EQUAL_FLAG");
                currentIndex++;
            ...
            else if(op_flag == 2 && equal_op == 5)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "mov " + v1 + " %LESS_EQUAL_FLAG");
                currentIndex++;
            ...
            else if(op_flag == 2 && equal_op == 6)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "mov " + v1 + " %NOT_EQUAL_FLAG");
                currentIndex++;
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            ...
            if(op_flag == 2)
            {
                if(current_op == 1)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "cmp " + v1 + " 0");
                    currentIndex++;
                    //tmp[currentIndex] = "mov " + v1 + " %NOT_EQUAL_FLAG";
                    rc_setStringArray(&tmp, currentIndex, "mov " + v1 + " %NOT_EQUAL_FLAG");
                    currentIndex++;
                    //tmp[currentIndex] = "cmp " + v2 + " 0";
                    rc_setStringArray(&tmp, currentIndex, "cmp " + v2 + " 0");
                    currentIndex++;
                    //tmp[currentIndex] = "mov " + v2 + " %NOT_EQUAL_FLAG";
                    rc_setStringArray(&tmp, currentIndex, "mov " + v2 + " %NOT_EQUAL_FLAG");
                    currentIndex++;
                    //tmp[currentIndex] = "and " + v1 + " " + v2;
                    rc_setStringArray(&tmp, currentIndex, "and " + v1 + " " + v2);
                    currentIndex++;
                }
                else if(current_op == 2)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "or " + v1 + " " + v2);
                    currentIndex++;
                }
                else if(current_op == 3)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "xor " + v1 + " " + v2);
                    currentIndex++;
                }
        ...
        for(int i = currentBlock_start; i < currentBlock_end; i++)
        {
            ...
            if(op_flag == 2)
            {
                ...
                rc_setStringArray(&tmp, currentIndex, "not " + v2);
                currentIndex++;
        ...
        if(rc_tokens[currentBlock_start-1].substr(0,4).compare("<id>")==0)
        {
               ...
               rc_tokens[currentBlock_start-1].substr(0,8).compare("<prc_id>")==0)
            {
                ...
                for(int i = 0; i < mi_place; i++)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "push m" + rc_intToString(i));
                    currentIndex++;
                    ns_use++;
                }
                si_place = s_index;
                for(int i = 0; i < si_place; i++)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "push$ s" + rc_intToString(i));
                    currentIndex++;
                    ss_use++;
                }
                string nt = "";
                for(int i = currentBlock_start; i <= currentBlock_end; i++)
                {
                    if(rc_tokens[i].substr(0,8).compare("<vm_var>")==0)
                    {
                        ...
                        else if(arg_type[arg_count].substr(0,1).compare("$")==0)
                        {
                            if(arg_value[arg_count].substr(0,1).compare("m")==0)
                            {
                                ...
                                rc_setStringArray(&tmp, currentIndex, "str$ s" + rc_intToString(s_index) + " " + arg_value[arg_count]);
                                currentIndex++;
                    ...
                    else if(rc_tokens[i].substr(0,4).compare("<id>")==0)
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "mov m" + rc_intToString(m_index) + " " + rc_tokens[i].substr(4));
            ...
            else //array
            {
                for(int i = currentBlock_start; i <= currentBlock_end; i++)
                {
                    ...
                    else if(rc_tokens[i].substr(0,4).compare("<id>")==0)
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "mov m" + rc_intToString(m_index) + " " + rc_tokens[i]);
               ...
               rc_tokens[currentBlock_start-1].substr(0,8).compare("<prc_id>")==0)
            {
                ...
                for(int i = 0; i < id_dim; i ++)
                {
                    if(rc_getID_data(arg_id[i], "id_type").compare("$")==0)
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "mov$ " + arg_id[i] + " " + arg_value[i]);
                        //cout << tmp[currentIndex] << endl;
                        currentIndex++;
                    }
                    ...
                    else if(rc_getID_data(arg_id[i], "id_type").substr(1,1).compare("&")==0)
                    {
                        ...
                        if(rc_getID_data(arg_value[i],"id_type").compare("#A")==0)
                        {
                            ...
                            rc_setStringArray(&tmp, currentIndex, "ptr " + arg_id[i] + " " + arg_value[i]);
                        }
                ...
                if(rc_isBuiltIn_ID(id,arg_count,currentIndex)==0)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "gosub [" + id + "]");
                    isIntern = 1;
                ...
                if(isIntern == 1 && rc_tokens[currentBlock_start-1].substr(0,8).compare("<fcn_id>")==0)
                {
                    if(id_type.substr(0,1).compare("$")==0)
                    {
                        ...
                        rc_setStringArray(&tmp, currentIndex, "pop$ s" + rc_intToString(s_index));
                    }
                    else if(id_type.substr(0,1).compare("#")==0)
                    {
                        //tmp[currentIndex] = "pop m" + rc_intToString(m_index);
                        rc_setStringArray(&tmp, currentIndex, "pop m" + rc_intToString(m_index));
                    }
                }
                ...
                for(int i = si_place-1; i >= 0; i--)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "pop$ s" + rc_intToString(i));
                    currentIndex++;
                }
                ...
                for(int i = mi_place-1; i >= 0; i--)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "pop m" + rc_intToString(i));
                    currentIndex++;
                }
                     ...
                     (rc_tokens[currentBlock_start-1].substr(0,8).compare("<ref_id>")==0 && id_type.compare("#&")==0) )
            {
                if(arg_count == 1)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, "arr1 " + id);
                }
                else if(arg_count == 2)
                {
                    //tmp[currentIndex] = "arr2 " + id;
                    rc_setStringArray(&tmp, currentIndex, "arr2 " + id);
                }
                else if(arg_count == 3)
                {
                    //tmp[currentIndex] = "arr3 " + id;
                    rc_setStringArray(&tmp, currentIndex, "arr3 " + id);
                }
                else
                {
                ...
                for(int i = 0; i < id_dim; i ++)
                {
                    ...
                    rc_setStringArray(&tmp, currentIndex, rc_getStringArrayValue(tmp,currentIndex) + " " + arg_value[i]);
                }

                //tmp[currentIndex] += " m"+rc_intToString(m_index);
                rc_setStringArray(&tmp, currentIndex, rc_getStringArrayValue(tmp,currentIndex) + " m"+rc_intToString(m_index));
                currentIndex++;
            }
            else if( (rc_tokens[currentBlock_start-1].substr(0,8).compare("<arr_id>")==0 && id_type.compare("$A")==0) ||
                     (rc_tokens[currentBlock_start-1].substr(0,8).compare("<ref_id>")==0 && id_type.compare("$&")==0) )
            {
                ...
                rc_setStringArray(&tmp, currentIndex, rc_getStringArrayValue(tmp,currentIndex) + " s"+rc_intToString(s_index));
                currentIndex++;
            }
...
int rc_evalID(int eid_flag = 0)
{
        ...
        if(rc_tokens[1].substr(0,4).compare("<id>")==0)
        {
            ...
            if(rc_tokens[2].compare("<square>")==0)
            {
                ...
                if(eid_typeCheck.compare("#A")==0)
                {
                    ...
                    rc_setStringArray(&tmp, tmp_count, "dim " + eid + " " + id_args[0][0] + " " + id_args[1][0] + " " + id_args[2][0]);
                }
                else
                {
                    //tmp[tmp_count] = "dim$ " + eid + " " + id_args[0][0] + " " + id_args[1][0] + " " + id_args[2][0];
                ...
                for(int i = 1; i <= id_args_count1; i++)
                {
                    ...
                    rc_setStringArray(&tmp, tmp_count, "mul " + id_args[0][0] + " " + id_args[i][0]);
                ...
                if(eid_typeCheck.compare("#A")==0)
                {
                    if(dim_exist)
                    {
                        ...
                        rc_setStringArray(&tmp, tmp_count, "alloc " + id_args[0][0] + " # @" + rc_intToString(dim_index));
                        tmp_count++;
                    }
                    else
                    {
                        //tmp[tmp_count] = "alloc " + id_args[0][0] + " # @" + rc_intToString(nid_count);
                        rc_setStringArray(&tmp, tmp_count, "alloc " + id_args[0][0] + " # @" + rc_intToString(nid_count));
                        tmp_count++;
                        nid_count++;
                    }
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        rc_setStringArray(&tmp, tmp_count, "alloc " + id_args[0][0] + " $ @" + rc_intToString(sid_count));
                        tmp_count++;
                        sid_count++;
                    }
                }
                ...
                if(!dim_exist)
                {
                    ...
                    rc_setStringArray(&rc_id, rc_id_count, eid+" ");
                ...
                else
                {
                    ...
                    rc_setStringArray(&rc_id, dim_rc_id, eid + rc_intToString(dim_index) + " ");
    ...
    else if( (rc_tokens[0].compare("<function>")==0 || rc_tokens[0].compare("<procedure>")==0) && eid_flag == 0)
    {
        ...
        //tmp[tmp_count] = ".DATA";
        rc_setStringArray(&tmp, tmp_count, ".DATA");
        tmp_count++;
        ...
        if(rc_tokens[1].substr(0,4).compare("<id>")==0)
        {
            ...
            rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + "]");
            tmp_count++;
            label_count++;
            ...
            if(rc_tokens[2].compare("<par>")==0)
            {
                ...
                rc_setStringArray(&rc_id, fcn_id, eid + " " + eid_typeCheck + " " + rc_intToString(rc_data_offset) + " " + rc_intToString(current_scope) + " " + rc_intToString(id_args_count1)+" 0 0 ");
                ...
                for(int i = 0; i < id_args_count1; i++)
                {
                    ...
                    rc_setStringArray(&rc_id, rc_id_count, eid + "." + id_args[i][0]);
                    if(id_args[i][0].substr(id_args[i][0].length()-1,1).compare("$")==0)
                    {
                        if(id_args[i][1].compare("&")==0)
                        {
                            //rc_id[rc_id_count] += " $& ";
                            rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + " $& ");
                            byref_check = 2;
                        }
                        else
                        {
                    ...
                    rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + rc_intToString(rc_data_offset) + " " + rc_intToString(current_scope) + " 0 ");
                    //cout << "dbg_fcn: " << rc_id[rc_id_count] << endl;

                    if(id_args[i][0].substr(id_args[i][0].length()-1,1).compare("$")==0)
                    {
                        //rc_id[rc_id_count] += rc_intToString(sid_count) + " ";
                        rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + rc_intToString(sid_count) + " ");
                        if(byref_check == 2)
                        {
                    ...
                    else
                    {
                        ...
                        rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + rc_intToString(nid_count) + " ");
                        if(byref_check == 1)
                        {
    ...
    else if(eid_flag == 0)
    {
        ...
        if(rc_tokens_count >= 3)
        {
            if(rc_tokens[0].substr(0,4).compare("<id>")==0)
            {
                ...
                //cout << "search_ID probly gonna crash" << endl;
                string eid_tmp = rc_searchID(eid);

                //cout << "ok it did not crash, lets try it again" << endl;

                if(eid_tmp.compare("") == 0)
                        eid_tmp = rc_searchID(eid+"$");

                //cout << "mutha wiggling" <<endl;

                 if(eid_tmp.compare("")==0)
                 {
                     //cout << "setstring" <<endl;
                     //rc_id[rc_id_count] = relative_scope+"."+eid+" "+eid_typeCheck+" "+rc_intToString(rc_id_count)+" "+rc_intToString(current_scope)+" 0 ";
                     rc_setStringArray(&rc_id, rc_id_count, relative_scope+"."+eid+" "+eid_typeCheck+" "+rc_intToString(rc_id_count)+" "+rc_intToString(current_scope)+" 0 ");
                     if(eid_typeCheck.compare("#")==0)
                     {
                         //cout << "#"<<endl;
                         //rc_id[rc_id_count] += rc_intToString(nid_count) + " 0 ";
                         rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + rc_intToString(nid_count) + " 0 ");
                         nid_count++;
                     }
                     else
                     {
                         ...
                         rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + rc_intToString(sid_count) + " 0 ");
                         sid_count++;
                     }
                     //cout << "RC_ID --> " << rc_id[rc_id_count] << endl;
                     rc_id_count++;
...
//                }
                 ...
                 if(eid_type.substr(0,1).compare("#")==0)
                 {
                     ...
                     if(f_rtn)
                     {
                         ...
                         rc_setStringArray(&tmp, tmp_count, "push " + rc_result);
                         tmp_count++;
                         //tmp[tmp_count] = "return";
                         rc_setStringArray(&tmp, tmp_count, "return");
                         tmp_count++;
                     }
                     else
                    {
                        //tmp[tmp_count] = "mov "+ eid +" " + rc_result;//v1 is id
                        rc_setStringArray(&tmp, tmp_count, "mov "+ eid +" " + rc_result);
                        tmp_count++;
                    }
                 }
                 else if(eid_type.substr(0,1).compare("$")==0)
                 {
                     ...
                     if(s==0)
                     {
                         ...
                         rc_setStringArray(&tmp, tmp_count, "str$ s0 " + rc_result);
                         rc_result = "s0";
                         tmp_count++;
                     }
                     if(f_rtn)
                                                             ...
                                                             rc_getID_data(rc_searchID(eid+"$"),"id_type").compare("$&")==0 || rc_getID_data(rc_searchID(eid+"$"),"id_type").compare("$A")==0))
                {
                    ...
                    for(int i = 2; i < rc_tokens_count; i++)
                    {
                        ...
                        {
                            id_args_count1++;
                            //cout << "Increase ARG_COUNT to " << id_args_count1 << " on " << i << endl;
                                ...
                                if(rc_tokens[i+1].compare("<equal>")==0)
                                {
                                    ...
                                    for(i = 0; i < id_args_count1; i++)
                                    {
                                        ...
                                        for(int i2 = 0; i2 < id_args_count2[i]; i2++)
                                        {
                                            ...
                                            rc_tokens_count++;
                                            //cout << "ID_ARG_TK[" << i2 << "] = " << rc_tokens[i2] << endl;
                                        }
                                    ...
                                    if((atoi(rc_getID_data(eid,"id_dim").c_str())==id_args_count1 && eid_type.compare("#A")==0) || eid_type.compare("#&")==0)
                                    {
                                        switch(id_args_count1)
                                        {
                                            case 1: //tmp[tmp_count] = "set_arr1 " + eid + " " + id_args[0][0] + " " + arr_store;
                                                    rc_setStringArray(&tmp, tmp_count, "set_arr1 " + eid + " " + id_args[0][0] + " " + arr_store);
                                                    tmp_count++;
                                                    break;
                                            case 2: //tmp[tmp_count] = "set_arr2 " + eid + " " + id_args[0][0] + " " + id_args[1][0] + " " + arr_store;
                                                    rc_setStringArray(&tmp, tmp_count, "set_arr2 " + eid + " " + id_args[0][0] + " " + id_args[1][0] + " " + arr_store);
                                                    tmp_count++;
                                                    break;
                                            case 3: //tmp[tmp_count] = "set_arr3 " + eid + " " + id_args[0][0] + " " + id_args[1][0] + " " + id_args[2][0] + " " + arr_store;
                                                    rc_setStringArray(&tmp, tmp_count, "set_arr3 " + eid + " " + id_args[0][0] + " " + id_args[1][0] + " " + id_args[2][0] + " " + arr_store);
                                                    tmp_count++;
                                                    break;
                                        }
                                        return 1;
                                    ...
                                    else if((atoi(rc_getID_data(eid,"id_dim").c_str())==id_args_count1 && eid_type.compare("$A")==0) || eid_type.compare("$&")==0)
                                    {
                                        if(s==0)
                                        {
                                            ...
                                            rc_setStringArray(&tmp, tmp_count, "str$ s" + rc_intToString(s_index) + " " + arr_store);
                        ...
                        if(rc_tokens[i].compare("<sep>")==0 && p==1)
                        {
                            id_args_count1++;
...
string if_control[1024];
int if_control_index[1024];
int sel_control_index[1024];
    ...
    if(rc_tokens[0].compare("<for>")==0) // if next then it all variables within in this scope will be deleted
    {
        ...
        if(rc_tokens[1].substr(0,4).compare("<id>")==0)
        {
            ...
            if(eid.compare("")==0)
            {
                ...
                rc_setStringArray(&rc_id, rc_id_count, relative_scope + "." + rc_tokens[1].substr(4) + " # " + rc_intToString(nid_count) + " " + rc_intToString(current_scope) + " 0 " + rc_intToString(nid_count) + " 0 ");
                eid = relative_scope + "." + rc_tokens[1].substr(4);
                rc_id_count++;
                nid_count++;
                //rc_data_offset += 4;
            ...
            if(rc_tokens[2].compare("<equal>")==0)
            {
                ...
                if(rc_tokens[i].compare("<to>")==0 && (i+1) < rc_tokens_count)
                {
                    ...
                    for(i = 0; i < l_tokens_count1; i++)
                    {
                        ...
                        rc_setStringArray(&tmp, tmp_count, "mov f" + rc_intToString(f_index) + " " + rc_result);
                        tmp_count++;
                    ...
                    if(l_tokens_count1 != 3)
                    {
                        ...
                        rc_setStringArray(&tmp, tmp_count, "mov f" + rc_intToString(f_index) + " 1 ");
                    ...
                    rc_setStringArray(&tmp, tmp_count, "mov " + eid + " " + l_tokens[0][0]);
                    tmp_count++;

                    //test of new for loop
                    //tmp[tmp_count] = "for " + eid + " " + l_tokens[1][0] + " " + l_tokens[2][0];
                    rc_setStringArray(&tmp, tmp_count, "for " + eid + " " + l_tokens[1][0] + " " + l_tokens[2][0]);
                    tmp_count++;
                    ...
                    rc_setStringArray(&rc_id, rc_id_count, relative_scope + " [LABEL] ");

                    if(rc_segment_switch == RC_DATA_SEGMENT_SWITCH)
                    {
                        //rc_id[rc_id_count] += rc_intToString(rc_data_offset) + " 55 65 75 ";
                        rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + rc_intToString(rc_data_offset) + " 55 65 75 ");
                    }
                    else
                    {
                        //rc_id[rc_id_count] += rc_intToString(rc_code_offset) + " 55 65 75 ";
                        rc_setStringArray(&rc_id, rc_id_count, rc_getStringArrayValue(rc_id,rc_id_count) + rc_intToString(rc_code_offset) + " 55 65 75 ");
                    }
...
//                    return 1;
    ...
    else if(rc_tokens[0].compare("<next>")==0)
    {
        ...
        //tmp[tmp_count] = "next";
        rc_setStringArray(&tmp, tmp_count, "next");
        tmp_count++;

        //tmp[tmp_count] = "label [" + relative_scope + "_end]";
        rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + "_end]");
        label_count++;

        //rc_id[rc_id_count] = relative_scope + "_end [LABEL] ";
        rc_setStringArray(&rc_id, rc_id_count, relative_scope + "_end [LABEL] ");
...
//        return 1;
    ...
    else if(rc_tokens[0].compare("<while>")==0)
    {
        ...
        for(; i < w_end; i++)
        {
            wcon_code[wcon_index][n] = rc_getStringArrayValue(tmp, i);
            n++;
        }
        wcon_count[wcon_index] = n;
        wcon_index++;

        //tmp[tmp_count] = "cmp " + rc_result + " 0 ";
        rc_setStringArray(&tmp, tmp_count, "cmp " + rc_result + " 0 ");
        tmp_count++;
        //tmp[tmp_count] = "je !fwd![" + relative_scope + ".!end_loop]";
        rc_setStringArray(&tmp, tmp_count, "je !fwd![" + relative_scope + ".!end_loop]");
        tmp_count++;

        //new while loop
        //tmp[tmp_count] = "while " + rc_result;
        rc_setStringArray(&tmp, tmp_count, "while " + rc_result);
        tmp_count++;
...
//        rc_setStringArray(&tmp, tmp_count, "je [" + relative_scope + ".!end_loop]");
//        tmp_count++;
//        //cout << "Scope = " << relative_scope << endl;
//
//        rc_clearTokens();
...
//        return 1;
    ...
    else if(rc_tokens[0].compare("<wend>")==0)
    {
        ...
        for(int i = 0; i < wcon_count[wcon_index]; i++)
        {
            rc_setStringArray(&tmp, tmp_count, wcon_code[wcon_index][i]);
            tmp_count++;
        }
...
//        {
//            //tmp[tmp_count] = tmp[i];
//            rc_setStringArray(&tmp, tmp_count, rc_getStringArrayValue(tmp,i));
//            tmp_count++;
//        }

        //tmp[tmp_count] = "wend [" + relative_scope + "]";
        rc_setStringArray(&tmp, tmp_count, "wend [" + relative_scope + "]");
        tmp_count++;

        //tmp[tmp_count] = "label [" + relative_scope + ".!end_loop]";
        rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + ".!end_loop]");
        label_count++;

        //rc_id[rc_id_count] = relative_scope + ".!end_loop [LABEL] ";
        rc_setStringArray(&rc_id, rc_id_count, relative_scope + ".!end_loop [LABEL] ");
...
//        return 1;
    ...
    else if(rc_tokens[0].compare("<do>")==0)
    {
        ...
        //tmp[tmp_count] = "do";
        rc_setStringArray(&tmp, tmp_count, "do");
        tmp_count++;
...
//        return 1;
    ...
    else if(rc_tokens[0].compare("<loop>")==0)
    {
        ...
        if(rc_tokens_count == 1)
        {
            //new loop
            //tmp[tmp_count] = "loop";
            rc_setStringArray(&tmp, tmp_count, "loop");
            tmp_count++;
            //tmp[tmp_count] = "label [" + relative_scope + ".!end_loop]";
            rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + ".!end_loop]");
            label_count++;
...
//            return 1;
        ...
        else
        {
            if(rc_tokens[1].compare("<until>")==0) //still needs tweeking, to do: need to check if rc_result is s# or m#
            {
                ...
                rc_setStringArray(&tmp, tmp_count, "loop_until " + rc_result);
                tmp_count++;
                //tmp[tmp_count] = "label [" + relative_scope + ".!end_loop]";
                rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + ".!end_loop]");
                label_count++;
...
//                return 1;
            ...
            else if(rc_tokens[1].compare("<while>")==0)
            {
                ...
                rc_setStringArray(&tmp, tmp_count, "loop_while " + rc_result);
                tmp_count++;
                //tmp[tmp_count] = "label [" + relative_scope + ".!end_loop]";
                rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + ".!end_loop]");
                label_count++;
...
//                return 1;
    ...
    else if(rc_tokens[0].compare("<if>")==0)
    {
        ...
        if(rc_mathParser(m_index, s_index)==0)
        {
            if(rc_result.substr(0,1).compare("s")==0)
            {
                ...
                rc_setStringArray(&tmp, tmp_count, "mov m" + rc_intToString(m_index) + " 0 ");
            ...
            rc_setStringArray(&tmp, tmp_count, "je [" + relative_scope + "_Condition<" + rc_intToString(if_control_index[current_scope]) + ">]");
    ...
    else if(rc_tokens[0].compare("<else>")==0)
    {
        ...
        if(rc_tokens[1].compare("<if>")==0)
        {
            ...
            rc_setStringArray(&tmp, tmp_count, "jmp [" + relative_scope + "_end]");
            tmp_count++;
            ...
            rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + "_Condition<" + rc_intToString(if_control_index[current_scope]) + ">]");
            label_count++;
            ...
            rc_setStringArray(&rc_id, rc_id_count, relative_scope + "_Condition<" + rc_intToString(if_control_index[current_scope]) + ">");
        ...
        else if(rc_tokens_count==1)
        {
            ...
            //cout << "LABEL created called #" <<rc_id.str[rc_id_count] << "#" << endl;
            rc_id_count++;

            tmp_count++;
            current_condition[block_handle-1]++;
            rc_clearTokens();
            //cout << "Else DEBUG end" << endl;
            return 1;
        }
    }
    ...
    else if(rc_tokens[0].compare("<end>")==0)
    {
        ...
        {
            //tmp[tmp_count] = "end 0";
            rc_setStringArray(&tmp, tmp_count, "end 0");
            tmp_count++;
            rc_clearTokens();
            rc_tokens_count = 0;
            rc_clearTokens();
        ...
        if(rc_tokens[1].compare("<if>")==0)
        {
            ...
            rc_setStringArray(&rc_id, rc_id_count, relative_scope + "_end");
        ...
        else if(rc_tokens[1].compare("<function>")==0)
        {
            ...
            rc_setStringArray(&tmp, tmp_count, "push 0");
            tmp_count++;
            //tmp[tmp_count] = "return";
            rc_setStringArray(&tmp, tmp_count, "return");
            tmp_count++;
            //tmp[tmp_count] = ".CODE";
            rc_setStringArray(&tmp, tmp_count, ".CODE");
            tmp_count++;
        ...
        else if(rc_tokens[1].compare("<select>")==0)
        {
            ...
            rc_setStringArray(&tmp, tmp_count, "label [" + relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope]) +">]");
            label_count++;

            //rc_id[rc_id_count] = relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope]) + ">";
            rc_setStringArray(&rc_id, rc_id_count, relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope]) + ">");
            ...
            rc_setStringArray(&tmp, tmp_count, "pop m0");
            tmp_count++;
        ...
        if(rc_tokens[1].compare("<for>")==0)
        {
            ...
            while(true)
            {
                ...
                if(a.substr(0,4).compare("!FOR") == 0)
                {
                    ...
                    rc_setStringArray(&tmp, tmp_count, "exit " + rc_intToString(exit_arg));
                    tmp_count++;
                    //tmp[tmp_count] = "jmp !fwd![" + rs + "_end" + "]";
                    rc_setStringArray(&tmp, tmp_count, "jmp !fwd![" + rs + "_end" + "]");
        ...
        else if(rc_tokens[1].compare("<do>")==0)
        {
            ...
            while(true)
            {
                ...
                if(a.substr(0,3).compare("!do") == 0)
                {
                    ...
                    rc_setStringArray(&tmp, tmp_count, "jmp !fwd![" + rs + ".!end_loop" + "]");
                    //cout << "::::::: " << tmp[tmp_count] << endl;
                    tmp_count++;
                    return 1;
                }
    ...
    else if(rc_tokens[0].compare("<select>")==0)
    {
        if(rc_tokens[1].compare("<case>")==0)
        {
            ...
            rc_setStringArray(&tmp, tmp_count, "jmp [" + relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope+1]) + ">]");
            //cout << "SELECT_DEBUG: " << tmp[tmp_count] << endl;
            tmp_count++;
    ...
    else if(rc_tokens[0].compare("<case>")==0)
    {
        ...
        if(select_result.substr(select_result.length()-1,1).compare("s")==0)
        {
            if(rc_result.substr(0,1).compare("s")!=0)
            {
                ...
                rc_setStringArray(&tmp, tmp_count, "str$ s" + rc_intToString(s_index) + " " + rc_result);
                rc_result = "s"+rc_intToString(s_index);
                s_index++;
                tmp_count++;
            }
            //tmp[tmp_count] = "pop s" + rc_intToString(s_index);
            rc_setStringArray(&tmp, tmp_count, "pop s" + rc_intToString(s_index));
            tmp_count++;
            //tmp[tmp_count] = "cmp$ s" + rc_intToString(s_index) + " " + rc_result;
            rc_setStringArray(&tmp, tmp_count, "cmp$ s" + rc_intToString(s_index) + " " + rc_result);
            tmp_count++;
            //tmp[tmp_count] = "push s" + rc_intToString(s_index);
            rc_setStringArray(&tmp, tmp_count, "push s" + rc_intToString(s_index));
            tmp_count++;
            //tmp[tmp_count] = "jne [" + relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope]) + ">]";
            rc_setStringArray(&tmp, tmp_count, "jne [" + relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope]) + ">]");
            tmp_count++;
        }
        else if(select_result.substr(select_result.length()-1,1).compare("m")==0)
        {
            ...
            rc_setStringArray(&tmp, tmp_count, "pop m" + rc_intToString(m_index));
            tmp_count++;
            //tmp[tmp_count] = "cmp m" + rc_intToString(m_index) + " " + rc_result;
            rc_setStringArray(&tmp, tmp_count, "cmp m" + rc_intToString(m_index) + " " + rc_result);
            tmp_count++;
            //tmp[tmp_count] = "push m" + rc_intToString(m_index);
            rc_setStringArray(&tmp, tmp_count, "push m" + rc_intToString(m_index));
            tmp_count++;
            //tmp[tmp_count] = "jne [" + relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope]) + ">]";
            rc_setStringArray(&tmp, tmp_count, "jne [" + relative_scope + "_Case<" + rc_intToString(sel_control_index[current_scope]) + ">]");
    ...
    else if(rc_tokens[0].compare("<return>")==0)
    {
        ...
        //Clear Stack
        //cout << "DEBUG_RETURN" << endl;
        for(int i = 0; i < used_n_stack; i++)
        {
            //tmp[tmp_count] = "pop m" + rc_intToString(m_index);
            rc_setStringArray(&tmp, tmp_count, "pop m" + rc_intToString(m_index));
            //cout << tmp[tmp_count] << endl;
        ...
        //EXIT LOOP START
            ...
            while(true)
            {
                ...
                if(a.substr(0,7).compare("PROGRAM") == 0)
                {
                    ...
                    rc_setStringArray(&tmp, tmp_count, "r_exit " + rc_intToString(exit_arg));
                    tmp_count++;
                    break;
                }
    ...
    else if(rc_tokens[0].compare("<delete>")==0)
    {
        ...
        if(rc_tokens[1].substr(0,4).compare("<id>")==0 && rc_tokens_count == 2)
        {
            ...
            else
            {
                ...
                rc_setStringArray(&tmp, tmp_count, "delete " + rc_tokens[1]);
                tmp_count++;
    ...
    else if(rc_tokens[0].compare("<print>")==0)
    {
        ...
        rc_setStringArray(&tmp, tmp_count, "print " + rc_result);
        tmp_count++;
        rc_clearTokens();
    }
        ...
        if(rc_tokens[i].length() >= 4)
        {
            if(rc_tokens[i].substr(0,4).compare("<id>")==0)
            {
                ...
                if(rc_tokens[i+1].compare("<par>")==0)
                {
                    ...
                    eid_type = rc_getID_data(eid,"id_type");
                    //cout << "compare" << endl;
                    if(eid_type.compare("")!=0 && eid_type.length() > 1)
                ...
                {
                    //cout << "arr_searchID" << endl;
                    //cout << "start_ID=" << eid << endl;
                    eid = rc_searchID(eid);
                    //cout << "arr_getID data" << endl;
                    eid_type = rc_getID_data(eid,"id_type");
                    //cout << "compare" << endl;
                    ...
                    if(eid_type.compare("")!=0 && eid_type.length() > 1)
                        if(eid_type.substr(1,1).compare("F")==0 || eid_type.substr(1,1).compare("P")==0)
                        {
                            ...
                            //cout << "ID=" << eid << ";" << endl;
                            //cout << "Type:" << eid_type << endl;
                            //cout << "rc_id str_size=" << rc_id.str_size << endl;
                            //cout << "rc_id array_size=" << rc_id.array_size << endl;
                            //cout << "rc_id inc_size=" << rc_id.inc_size << endl;
                            //string s; cin >> s;
                            //for(int n = 0; n < rc_id_count; n++)
                            //    cout << rc_getStringArrayValue(rc_id, n) << endl;
                            return 2;
                        }
                }
            }
...
{
    rc_setStringArray(&rc_id, 0, "PROGRAM.FPRINT #F 0 0 1 1 0 ");
    rc_setStringArray(&rc_id, 1, "PROGRAM.FPRINT.S$ $ 1 1 0 0 0 ");
    rc_setStringArray(&rc_id, 2, "PROGRAM.NUMCOMMANDS #F 2 0 0 0 0 ");
    rc_setStringArray(&rc_id, 3, "PROGRAM.ARRAYDIM #F 3 0 1 2 0 ");
    rc_setStringArray(&rc_id, 4, "PROGRAM.ARRAYDIM.ARR_ID #& 4 1 0 0 ~ ");
    rc_setStringArray(&rc_id, 5, "PROGRAM.ARRAYDIM.ARR_ID$ $& 5 1 0 1 1 ");
    rc_setStringArray(&rc_id, 6, "PROGRAM.ARRAYSIZE #F 6 0 2 3 0 ");
    rc_setStringArray(&rc_id, 7, "PROGRAM.ARRAYSIZE.ARR_ID #& 7 1 0 1 ~ ");
    rc_setStringArray(&rc_id, 8, "PROGRAM.ARRAYSIZE.ARR_ID$ $& 8 1 0 2 1 ");
    rc_setStringArray(&rc_id, 9, "PROGRAM.ARRAYSIZE.ARR_DIM # 9 1 0 2 0 ");
    rc_setStringArray(&rc_id, 10, "PROGRAM.ASC #F 10 0 1 1 0 ");
    rc_setStringArray(&rc_id, 11, "PROGRAM.ASC.C$ $ 11 1 0 3 0 ");
    rc_setStringArray(&rc_id, 12, "PROGRAM.CHR$ $F 12 0 1 1 0 ");
    rc_setStringArray(&rc_id, 13, "PROGRAM.CHR$.N # 13 1 0 3 0 ");
    rc_setStringArray(&rc_id, 14, "PROGRAM.INSERT$ $F 14 0 3 3 0 ");
    rc_setStringArray(&rc_id, 15, "PROGRAM.INSERT$.SRC$ $ 15 1 0 4 0 ");
    rc_setStringArray(&rc_id, 16, "PROGRAM.INSERT$.TGT$ $ 16 1 0 5 0 ");
    rc_setStringArray(&rc_id, 17, "PROGRAM.INSERT$.POS # 17 1 0 4 0 ");
    rc_setStringArray(&rc_id, 18, "PROGRAM.INSTR #F 18 0 2 2 0 ");
    rc_setStringArray(&rc_id, 19, "PROGRAM.INSTR.STRING$ $ 19 1 0 6 0 ");
    rc_setStringArray(&rc_id, 20, "PROGRAM.INSTR.SUBSTR$ $ 20 1 0 7 0 ");
    rc_setStringArray(&rc_id, 21, "PROGRAM.LCASE$ $F 21 0 1 1 0 ");
    rc_setStringArray(&rc_id, 22, "PROGRAM.LCASE$.STRING$ $ 22 1 0 8 0 ");
    rc_setStringArray(&rc_id, 23, "PROGRAM.LEFT$ $F 23 0 2 2 0 ");
    rc_setStringArray(&rc_id, 24, "PROGRAM.LEFT$.STRING$ $ 24 1 0 9 0 ");
    rc_setStringArray(&rc_id, 25, "PROGRAM.LEFT$.N # 25 1 0 5 0 ");
    rc_setStringArray(&rc_id, 26, "PROGRAM.LENGTH #F 26 0 1 1 0 ");
    rc_setStringArray(&rc_id, 27, "PROGRAM.LENGTH.STRING$ $ 27 1 0 10 0 ");
    rc_setStringArray(&rc_id, 28, "PROGRAM.LTRIM$ $F 28 0 1 1 0 ");
    rc_setStringArray(&rc_id, 29, "PROGRAM.LTRIM$.STRING$ $ 29 1 0 11 0 ");
    rc_setStringArray(&rc_id, 30, "PROGRAM.MID$ $F 30 0 3 3 0 ");
    rc_setStringArray(&rc_id, 31, "PROGRAM.MID$.STRING$ $ 31 1 0 12 0 ");
    rc_setStringArray(&rc_id, 32, "PROGRAM.MID$.START # 32 1 0 6 0 ");
    rc_setStringArray(&rc_id, 33, "PROGRAM.MID$.N # 33 1 0 7 0 ");
    rc_setStringArray(&rc_id, 34, "PROGRAM.REPLACE$ $F 34 0 3 3 0 ");
    rc_setStringArray(&rc_id, 35, "PROGRAM.REPLACE$.SRC$ $ 35 1 0 13 0 ");
    rc_setStringArray(&rc_id, 36, "PROGRAM.REPLACE$.RPC$ $ 36 1 0 14 0 ");
    rc_setStringArray(&rc_id, 37, "PROGRAM.REPLACE$.POS # 37 1 0 8 0 ");
    rc_setStringArray(&rc_id, 38, "PROGRAM.REPLACESUBSTR$ $F 38 0 3 3 0 ");
    rc_setStringArray(&rc_id, 39, "PROGRAM.REPLACESUBSTR$.SRC$ $ 39 1 0 15 0 ");
    rc_setStringArray(&rc_id, 40, "PROGRAM.REPLACESUBSTR$.TGT$ $ 40 1 0 16 0 ");
    rc_setStringArray(&rc_id, 41, "PROGRAM.REPLACESUBSTR$.RPC$ $ 41 1 0 17 0 ");
    rc_setStringArray(&rc_id, 42, "PROGRAM.REVERSE$ $F 42 0 1 1 0 ");
    rc_setStringArray(&rc_id, 43, "PROGRAM.REVERSE$.STRING$ $ 43 1 0 18 0 ");
    rc_setStringArray(&rc_id, 44, "PROGRAM.RIGHT$ $F 44 0 2 2 0 ");
    rc_setStringArray(&rc_id, 45, "PROGRAM.RIGHT$.STRING$ $ 45 1 0 19 0 ");
    rc_setStringArray(&rc_id, 46, "PROGRAM.RIGHT$.N # 46 1 0 9 0 ");
    rc_setStringArray(&rc_id, 47, "PROGRAM.RTRIM$ $F 47 0 1 1 0 ");
    rc_setStringArray(&rc_id, 48, "PROGRAM.RTRIM$.STRING$ $ 48 1 0 20 0 ");
    rc_setStringArray(&rc_id, 49, "PROGRAM.FILLSTRING$ $F 49 0 2 2 0 ");
    rc_setStringArray(&rc_id, 50, "PROGRAM.FILLSTRING$.STRING$ $ 50 1 0 21 0 ");
    rc_setStringArray(&rc_id, 51, "PROGRAM.FILLSTRING$.N # 51 1 0 10 0 ");
    rc_setStringArray(&rc_id, 52, "PROGRAM.STR$ $F 52 0 1 1 0 ");
    rc_setStringArray(&rc_id, 53, "PROGRAM.STR$.VALUE # 53 1 0 11 0 ");
    rc_setStringArray(&rc_id, 54, "PROGRAM.TALLY #F 54 0 2 2 0 ");
    rc_setStringArray(&rc_id, 55, "PROGRAM.TALLY.STRING$ $ 55 1 0 22 0 ");
    rc_setStringArray(&rc_id, 56, "PROGRAM.TALLY.SUBSTR$ $ 56 1 0 23 0 ");
    rc_setStringArray(&rc_id, 57, "PROGRAM.TRIM$ $F 57 0 1 1 0 ");
    rc_setStringArray(&rc_id, 58, "PROGRAM.TRIM$.STRING$ $ 58 1 0 24 0 ");
    rc_setStringArray(&rc_id, 59, "PROGRAM.UCASE$ $F 59 0 1 1 0 ");
    rc_setStringArray(&rc_id, 60, "PROGRAM.UCASE$.STRING$ $ 60 1 0 25 0 ");
    rc_setStringArray(&rc_id, 61, "PROGRAM.VAL #F 61 0 1 1 0 ");
    rc_setStringArray(&rc_id, 62, "PROGRAM.VAL.STRING$ $ 62 1 0 26 0 ");
    rc_setStringArray(&rc_id, 63, "PROGRAM.ABS #F 63 0 1 1 0 ");
    rc_setStringArray(&rc_id, 64, "PROGRAM.ABS.N # 64 1 0 12 0 ");
    rc_setStringArray(&rc_id, 65, "PROGRAM.ACOS #F 65 0 1 1 0 ");
    rc_setStringArray(&rc_id, 66, "PROGRAM.ACOS.N # 66 1 0 13 0 ");
    rc_setStringArray(&rc_id, 67, "PROGRAM.ANDBIT #F 67 0 2 2 0 ");
    rc_setStringArray(&rc_id, 68, "PROGRAM.ANDBIT.A # 68 1 0 14 0 ");
    rc_setStringArray(&rc_id, 69, "PROGRAM.ANDBIT.B # 69 1 0 15 0 ");
    rc_setStringArray(&rc_id, 70, "PROGRAM.ASIN #F 70 0 1 1 0 ");
    rc_setStringArray(&rc_id, 71, "PROGRAM.ASIN.N # 71 1 0 16 0 ");
    rc_setStringArray(&rc_id, 72, "PROGRAM.ATAN #F 72 0 1 1 0 ");
    rc_setStringArray(&rc_id, 73, "PROGRAM.ATAN.N # 73 1 0 17 0 ");
    rc_setStringArray(&rc_id, 74, "PROGRAM.BIN$ $F 74 0 1 1 0 ");
    rc_setStringArray(&rc_id, 75, "PROGRAM.BIN.N # 75 1 0 18 0 ");
    rc_setStringArray(&rc_id, 76, "PROGRAM.COS #F 76 0 1 1 0 ");
    rc_setStringArray(&rc_id, 77, "PROGRAM.COS.ANGLE # 77 1 0 19 0 ");
    rc_setStringArray(&rc_id, 78, "PROGRAM.EXP #F 78 0 1 1 0 ");
    rc_setStringArray(&rc_id, 79, "PROGRAM.EXP.N # 79 1 0 20 0 ");
    rc_setStringArray(&rc_id, 80, "PROGRAM.FRAC #F 80 0 1 1 0 ");
    rc_setStringArray(&rc_id, 81, "PROGRAM.FRAC.N # 81 1 0 21 0 ");
    rc_setStringArray(&rc_id, 82, "PROGRAM.HEX$ $F 82 0 1 1 0 ");
    rc_setStringArray(&rc_id, 83, "PROGRAM.HEX$.VALUE # 83 1 0 22 0 ");
    rc_setStringArray(&rc_id, 84, "PROGRAM.INT #F 84 0 1 1 0 ");
    rc_setStringArray(&rc_id, 85, "PROGRAM.INT.N # 85 1 0 23 0 ");
    rc_setStringArray(&rc_id, 86, "PROGRAM.LOG #F 86 0 1 1 0 ");
    rc_setStringArray(&rc_id, 87, "PROGRAM.LOG.N # 87 1 0 24 0 ");
    rc_setStringArray(&rc_id, 88, "PROGRAM.MAX #F 88 0 2 2 0 ");
    rc_setStringArray(&rc_id, 89, "PROGRAM.MAX.A # 89 1 0 25 0 ");
    rc_setStringArray(&rc_id, 90, "PROGRAM.MAX.B # 90 1 0 26 0 ");
    rc_setStringArray(&rc_id, 91, "PROGRAM.MIN #F 91 0 2 2 0 ");
    rc_setStringArray(&rc_id, 92, "PROGRAM.MIN.A # 92 1 0 27 0 ");
    rc_setStringArray(&rc_id, 93, "PROGRAM.MIN.B # 93 1 0 28 0 ");
    rc_setStringArray(&rc_id, 94, "PROGRAM.ORBIT #F 94 0 2 2 0 ");
    rc_setStringArray(&rc_id, 95, "PROGRAM.ORBIT.A # 95 1 0 29 0 ");
    rc_setStringArray(&rc_id, 96, "PROGRAM.ORBIT.B # 96 1 0 30 0 ");
    rc_setStringArray(&rc_id, 97, "PROGRAM.RANDOMIZE #F 97 0 1 1 0 ");
    rc_setStringArray(&rc_id, 98, "PROGRAM.RANDOMIZE.N # 98 1 0 31 0 ");
    rc_setStringArray(&rc_id, 99, "PROGRAM.RAND #F 99 0 1 1 0 ");
    rc_setStringArray(&rc_id, 100, "PROGRAM.RAND.N # 100 1 0 32 0 ");
    rc_setStringArray(&rc_id, 101, "PROGRAM.ROUND #F 101 0 1 1 0 ");
    rc_setStringArray(&rc_id, 102, "PROGRAM.ROUND.N # 102 1 0 33 0 ");
    rc_setStringArray(&rc_id, 103, "PROGRAM.SIGN #F 103 0 1 1 0 ");
    rc_setStringArray(&rc_id, 104, "PROGRAM.SIGN.N # 104 1 0 34 0 ");
    rc_setStringArray(&rc_id, 105, "PROGRAM.SIN #F 105 0 1 1 0 ");
    rc_setStringArray(&rc_id, 106, "PROGRAM.SIN.ANGLE # 106 1 0 35 0 ");
    rc_setStringArray(&rc_id, 107, "PROGRAM.SQRT #F 107 0 1 1 0 ");
    rc_setStringArray(&rc_id, 108, "PROGRAM.SQRT.N # 108 1 0 36 0 ");
    rc_setStringArray(&rc_id, 109, "PROGRAM.TAN #F 109 0 1 1 0 ");
    rc_setStringArray(&rc_id, 110, "PROGRAM.TAN.ANGLE # 110 1 0 37 0 ");
    rc_setStringArray(&rc_id, 111, "PROGRAM.XORBIT #F 111 0 2 2 0 ");
    rc_setStringArray(&rc_id, 112, "PROGRAM.XORBIT.A # 112 1 0 38 0 ");
    rc_setStringArray(&rc_id, 113, "PROGRAM.XORBIT.B # 113 1 0 39 0 ");
    rc_setStringArray(&rc_id, 114, "PROGRAM.FILEOPEN #F 114 0 3 3 0 ");
    rc_setStringArray(&rc_id, 115, "PROGRAM.FILEOPEN.STREAM # 115 1 0 40 0 ");
    rc_setStringArray(&rc_id, 116, "PROGRAM.FILEOPEN.FILE$ $ 116 1 0 27 0 ");
    rc_setStringArray(&rc_id, 117, "PROGRAM.FILEOPEN.IO_MODE # 117 1 0 41 0 ");
    rc_setStringArray(&rc_id, 118, "PROGRAM.FILECLOSE #F 118 0 1 1 0 ");
    rc_setStringArray(&rc_id, 119, "PROGRAM.FILECLOSE.STREAM # 119 1 0 42 0 ");
    rc_setStringArray(&rc_id, 120, "PROGRAM.READBYTE #F 120 0 1 1 0 ");
    rc_setStringArray(&rc_id, 121, "PROGRAM.READBYTE.STREAM # 121 1 0 43 0 ");
    rc_setStringArray(&rc_id, 122, "PROGRAM.WRITEBYTE #F 122 0 2 2 0 ");
    rc_setStringArray(&rc_id, 123, "PROGRAM.WRITEBYTE.STREAM # 123 1 0 44 0 ");
    rc_setStringArray(&rc_id, 124, "PROGRAM.WRITEBYTE.BYTE # 124 1 0 45 0 ");
    rc_setStringArray(&rc_id, 125, "PROGRAM.READLINE$ $F 125 0 1 1 0 ");
    rc_setStringArray(&rc_id, 126, "PROGRAM.READLINE$.STREAM # 126 1 0 46 0 ");
    rc_setStringArray(&rc_id, 127, "PROGRAM.WRITELINE #F 127 0 2 2 0 ");
    rc_setStringArray(&rc_id, 128, "PROGRAM.WRITELINE.STREAM # 128 1 0 47 0 ");
    rc_setStringArray(&rc_id, 129, "PROGRAM.WRITELINE.LINE$ $ 129 1 0 28 0 ");
    rc_setStringArray(&rc_id, 130, "PROGRAM.COPYFILE #F 130 0 2 2 0 ");
    rc_setStringArray(&rc_id, 131, "PROGRAM.COPYFILE.SRC$ $ 131 1 0 29 0 ");
    rc_setStringArray(&rc_id, 132, "PROGRAM.COPYFILE.DEST$ $ 132 1 0 30 0 ");
    rc_setStringArray(&rc_id, 133, "PROGRAM.REMOVEFILE #F 133 0 1 1 0 ");
    rc_setStringArray(&rc_id, 134, "PROGRAM.REMOVEFILE.FILE$ $ 134 1 0 31 0 ");
    rc_setStringArray(&rc_id, 135, "PROGRAM.FILEEXISTS #F 135 0 1 1 0 ");
    rc_setStringArray(&rc_id, 136, "PROGRAM.FILEEXISTS.FILE$ $ 136 1 0 32 0 ");
    rc_setStringArray(&rc_id, 137, "PROGRAM.MOVEFILE #F 137 0 2 2 0 ");
    rc_setStringArray(&rc_id, 138, "PROGRAM.MOVEFILE.SRC$ $ 138 1 0 33 0 ");
    rc_setStringArray(&rc_id, 139, "PROGRAM.MOVEFILE.DEST$ $ 139 1 0 34 0 ");
    rc_setStringArray(&rc_id, 140, "PROGRAM.RENAMEFILE #F 140 0 2 2 0 ");
    rc_setStringArray(&rc_id, 141, "PROGRAM.RENAMEFILE.FILE$ $ 141 1 0 35 0 ");
    rc_setStringArray(&rc_id, 142, "PROGRAM.RENAMEFILE.RENAME$ $ 142 1 0 36 0 ");
    rc_setStringArray(&rc_id, 143, "PROGRAM.FILELENGTH #F 143 0 1 1 0 ");
    rc_setStringArray(&rc_id, 144, "PROGRAM.FILELENGTH.FILE$ $ 144 1 0 37 0 ");
    rc_setStringArray(&rc_id, 145, "PROGRAM.TELL #F 145 0 1 1 0 ");
    rc_setStringArray(&rc_id, 146, "PROGRAM.TELL.STREAM # 146 1 0 48 0 ");
    rc_setStringArray(&rc_id, 147, "PROGRAM.SEEK #F 147 0 2 2 0 ");
    rc_setStringArray(&rc_id, 148, "PROGRAM.SEEK.STREAM # 148 1 0 49 0 ");
    rc_setStringArray(&rc_id, 149, "PROGRAM.SEEK.POSITION # 149 1 0 50 0 ");
    rc_setStringArray(&rc_id, 150, "PROGRAM.EOF #F 150 0 1 1 0 ");
    rc_setStringArray(&rc_id, 151, "PROGRAM.EOF.STREAM # 151 1 0 51 0 ");
    rc_setStringArray(&rc_id, 152, "PROGRAM.FREEFILE #F 152 0 0 0 0 ");
    rc_setStringArray(&rc_id, 153, "PROGRAM.CHANGEDIR #F 153 0 1 1 0 ");
    rc_setStringArray(&rc_id, 154, "PROGRAM.CHANGEDIR.PATH$ $ 154 1 0 38 0 ");
    rc_setStringArray(&rc_id, 155, "PROGRAM.DIREXISTS #F 155 0 1 1 0 ");
    rc_setStringArray(&rc_id, 156, "PROGRAM.DIREXISTS.PATH$ $ 156 1 0 39 0 ");
    rc_setStringArray(&rc_id, 157, "PROGRAM.DIRFIRST$ $F 157 0 0 0 0 ");
    rc_setStringArray(&rc_id, 158, "PROGRAM.DIR$ $F 158 0 0 0 0 ");
    rc_setStringArray(&rc_id, 159, "PROGRAM.DIRNEXT$ $F 159 0 0 0 0 ");
    rc_setStringArray(&rc_id, 160, "PROGRAM.MAKEDIR #F 160 0 1 1 0 ");
    rc_setStringArray(&rc_id, 161, "PROGRAM.MAKEDIR.PATH$ $ 161 1 0 40 0 ");
    rc_setStringArray(&rc_id, 162, "PROGRAM.REMOVEDIR #F 162 0 1 1 0 ");
    rc_setStringArray(&rc_id, 163, "PROGRAM.REMOVEDIR.PATH$ $ 163 1 0 41 0 ");
    rc_setStringArray(&rc_id, 164, "PROGRAM.DATE$ $F 164 0 0 0 0 ");
    rc_setStringArray(&rc_id, 165, "PROGRAM.TICKS #F 165 0 0 0 0 ");
    rc_setStringArray(&rc_id, 166, "PROGRAM.TIME$ $F 166 0 0 0 0 ");
    rc_setStringArray(&rc_id, 167, "PROGRAM.TIMER #F 167 0 0 0 0 ");
    rc_setStringArray(&rc_id, 168, "PROGRAM.WAIT #F 168 0 1 1 0 ");
    rc_setStringArray(&rc_id, 169, "PROGRAM.WAIT.MSEC # 169 1 0 52 0 ");
    rc_setStringArray(&rc_id, 170, "PROGRAM.INPUT$ $F 170 0 1 1 0 ");
    rc_setStringArray(&rc_id, 171, "PROGRAM.INPUT$.PROMPT $ 171 1 0 42 0 ");
    rc_setStringArray(&rc_id, 172, "PROGRAM.WINDOWOPEN #P 0 1 7 0 0 ");
    rc_setStringArray(&rc_id, 173, "PROGRAM.WINDOWOPEN.WIN_NUM # 0 1 0 53 ");
    rc_setStringArray(&rc_id, 174, "PROGRAM.WINDOWOPEN.TITLE$ $ 0 1 0 43 ");
    rc_setStringArray(&rc_id, 175, "PROGRAM.WINDOWOPEN.X # 0 1 0 54 ");
    rc_setStringArray(&rc_id, 176, "PROGRAM.WINDOWOPEN.Y # 0 1 0 55 ");
    rc_setStringArray(&rc_id, 177, "PROGRAM.WINDOWOPEN.W # 0 1 0 56 ");
    rc_setStringArray(&rc_id, 178, "PROGRAM.WINDOWOPEN.H # 0 1 0 57 ");
    rc_setStringArray(&rc_id, 179, "PROGRAM.WINDOWOPEN.MODE # 0 1 0 58 ");
    rc_setStringArray(&rc_id, 180, "PROGRAM.WINDOWCLOSE #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 181, "PROGRAM.WINDOWCLOSE.WIN_NUM # 0 1 0 59 ");
    rc_setStringArray(&rc_id, 182, "PROGRAM.RAISEWINDOW #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 183, "PROGRAM.WINDOW #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 184, "PROGRAM.WINDOW.WIN_NUM # 0 1 0 60 ");
    rc_setStringArray(&rc_id, 185, "PROGRAM.UPDATE #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 186, "PROGRAM.SHOWWINDOW #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 187, "PROGRAM.HIDEWINDOW #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 188, "PROGRAM.SETWINDOWTITLE #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 189, "PROGRAM.SETWINDOWTITLE.TITLE$ $ 0 1 0 44 ");
    rc_setStringArray(&rc_id, 190, "PROGRAM.WINDOWTITLE$ $F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 191, "PROGRAM.SETWINDOWPOSITION #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 192, "PROGRAM.SETWINDOWPOSITION.X # 0 1 0 61 ");
    rc_setStringArray(&rc_id, 193, "PROGRAM.SETWINDOWPOSITION.Y # 0 1 0 62 ");
    rc_setStringArray(&rc_id, 194, "PROGRAM.GETWINDOWPOSITION #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 195, "PROGRAM.GETWINDOWPOSITION.X #& 0 1 0 63 ");
    rc_setStringArray(&rc_id, 196, "PROGRAM.GETWINDOWPOSITION.Y #& 0 1 0 64 ");
    rc_setStringArray(&rc_id, 197, "PROGRAM.SETWINDOWSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 198, "PROGRAM.SETWINDOWSIZE.W # 0 1 0 65 ");
    rc_setStringArray(&rc_id, 199, "PROGRAM.SETWINDOWSIZE.H # 0 1 0 66 ");
    rc_setStringArray(&rc_id, 200, "PROGRAM.GETWINDOWSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 201, "PROGRAM.GETWINDOWSIZE.W #& 0 1 0 67 ");
    rc_setStringArray(&rc_id, 202, "PROGRAM.GETWINDOWSIZE.H #& 0 1 0 68 ");
    rc_setStringArray(&rc_id, 203, "PROGRAM.SETWINDOWMINSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 204, "PROGRAM.SETWINDOWMINSIZE.W # 0 1 0 69 ");
    rc_setStringArray(&rc_id, 205, "PROGRAM.SETWINDOWMINSIZE.H # 0 1 0 70 ");
    rc_setStringArray(&rc_id, 206, "PROGRAM.SETWINDOWMAXSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 207, "PROGRAM.SETWINDOWMAXSIZE.W # 0 1 0 71 ");
    rc_setStringArray(&rc_id, 208, "PROGRAM.SETWINDOWMAXSIZE.H # 0 1 0 72 ");
    rc_setStringArray(&rc_id, 209, "PROGRAM.GETWINDOWMINSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 210, "PROGRAM.GETWINDOWMINSIZE.W #& 0 1 0 73 ");
    rc_setStringArray(&rc_id, 211, "PROGRAM.GETWINDOWMINSIZE.H #& 0 1 0 74 ");
    rc_setStringArray(&rc_id, 212, "PROGRAM.GETWINDOWMAXSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 213, "PROGRAM.GETWINDOWMAXSIZE.W #& 0 1 0 75 ");
    rc_setStringArray(&rc_id, 214, "PROGRAM.GETWINDOWMAXSIZE.H #& 0 1 0 76 ");
    rc_setStringArray(&rc_id, 215, "PROGRAM.WINDOWISFULLSCREEN #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 216, "PROGRAM.WINDOWISVISIBLE #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 217, "PROGRAM.WINDOWISBORDERED #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 218, "PROGRAM.WINDOWISRESIZABLE #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 219, "PROGRAM.WINDOWISMINIMIZED #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 220, "PROGRAM.WINDOWISMAXIMIZED #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 221, "PROGRAM.SETWINDOWFULLSCREEN #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 222, "PROGRAM.SETWINDOWFULLSCREEN.FLAG # 0 1 0 77 ");
    rc_setStringArray(&rc_id, 223, "PROGRAM.MAXIMIZEWINDOW #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 224, "PROGRAM.MINIMIZEWINDOW #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 225, "PROGRAM.SETWINDOWBORDER #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 226, "PROGRAM.SETWINDOWBORDER.FLAG # 0 1 0 78 ");
    rc_setStringArray(&rc_id, 227, "PROGRAM.CANVASOPEN #P 0 1 8 0 0 ");
    rc_setStringArray(&rc_id, 228, "PROGRAM.CANVASOPEN.S_NUM # 0 1 0 79 ");
    rc_setStringArray(&rc_id, 229, "PROGRAM.CANVASOPEN.W # 0 1 0 80 ");
    rc_setStringArray(&rc_id, 230, "PROGRAM.CANVASOPEN.H # 0 1 0 81 ");
    rc_setStringArray(&rc_id, 231, "PROGRAM.CANVASOPEN.VPX # 0 1 0 82 ");
    rc_setStringArray(&rc_id, 232, "PROGRAM.CANVASOPEN.VPY # 0 1 0 83 ");
    rc_setStringArray(&rc_id, 233, "PROGRAM.CANVASOPEN.VPW # 0 1 0 84 ");
    rc_setStringArray(&rc_id, 234, "PROGRAM.CANVASOPEN.VPH # 0 1 0 85 ");
    rc_setStringArray(&rc_id, 235, "PROGRAM.CANVASOPEN.FLAG # 0 1 0 86 ");
    rc_setStringArray(&rc_id, 236, "PROGRAM.CANVASCLOSE #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 237, "PROGRAM.CANVASCLOSE.S_NUM # 0 1 0 87 ");
    rc_setStringArray(&rc_id, 238, "PROGRAM.SETCANVASVISIBLE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 239, "PROGRAM.SETCANVASVISIBLE.S_NUM # 0 1 0 88 ");
    rc_setStringArray(&rc_id, 240, "PROGRAM.SETCANVASVISIBLE.FLAG # 0 1 0 89 ");
    rc_setStringArray(&rc_id, 241, "PROGRAM.CANVASISVISIBLE #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 242, "PROGRAM.CANVASISVISIBLE.S_NUM # 0 1 0 90 ");
    rc_setStringArray(&rc_id, 243, "PROGRAM.SETCANVASVIEWPORT #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 244, "PROGRAM.SETCANVASVIEWPORT.X # 0 1 0 91 ");
    rc_setStringArray(&rc_id, 245, "PROGRAM.SETCANVASVIEWPORT.Y # 0 1 0 92 ");
    rc_setStringArray(&rc_id, 246, "PROGRAM.SETCANVASVIEWPORT.W # 0 1 0 93 ");
    rc_setStringArray(&rc_id, 247, "PROGRAM.SETCANVASVIEWPORT.H # 0 1 0 94 ");
    rc_setStringArray(&rc_id, 248, "PROGRAM.GETCANVASVIEWPORT #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 249, "PROGRAM.GETCANVASVIEWPORT.X #& 0 1 0 95 ");
    rc_setStringArray(&rc_id, 250, "PROGRAM.GETCANVASVIEWPORT.Y #& 0 1 0 96 ");
    rc_setStringArray(&rc_id, 251, "PROGRAM.GETCANVASVIEWPORT.W #& 0 1 0 97 ");
    rc_setStringArray(&rc_id, 252, "PROGRAM.GETCANVASVIEWPORT.H #& 0 1 0 98 ");
    rc_setStringArray(&rc_id, 253, "PROGRAM.CANVAS #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 254, "PROGRAM.CANVAS.S_NUM # 0 1 0 99 ");
    rc_setStringArray(&rc_id, 255, "PROGRAM.SETCANVASOFFSET #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 256, "PROGRAM.SETCANVASOFFSET.X # 0 1 0 100 ");
    rc_setStringArray(&rc_id, 257, "PROGRAM.SETCANVASOFFSET.Y # 0 1 0 101 ");
    rc_setStringArray(&rc_id, 258, "PROGRAM.GETCANVASOFFSET #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 259, "PROGRAM.GETCANVASOFFSET.X #& 0 1 0 102 ");
    rc_setStringArray(&rc_id, 260, "PROGRAM.GETCANVASOFFSET.Y #& 0 1 0 103 ");
    rc_setStringArray(&rc_id, 261, "PROGRAM.GETCANVASSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 262, "PROGRAM.GETCANVASSIZE.W #& 0 1 0 104 ");
    rc_setStringArray(&rc_id, 263, "PROGRAM.GETCANVASSIZE.H #& 0 1 0 105 ");
    rc_setStringArray(&rc_id, 264, "PROGRAM.CLEARCANVAS #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 265, "PROGRAM.SETCANVASALPHA #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 266, "PROGRAM.SETCANVASALPHA.ALPHA # 0 1 0 106 ");
    rc_setStringArray(&rc_id, 267, "PROGRAM.COPYCANVAS #P 0 1 8 0 0 ");
    rc_setStringArray(&rc_id, 268, "PROGRAM.COPYCANVAS.SRC_SCREEN # 0 1 0 107 ");
    rc_setStringArray(&rc_id, 269, "PROGRAM.COPYCANVAS.X # 0 1 0 108 ");
    rc_setStringArray(&rc_id, 270, "PROGRAM.COPYCANVAS.Y # 0 1 0 109 ");
    rc_setStringArray(&rc_id, 271, "PROGRAM.COPYCANVAS.W # 0 1 0 110 ");
    rc_setStringArray(&rc_id, 272, "PROGRAM.COPYCANVAS.H # 0 1 0 111 ");
    rc_setStringArray(&rc_id, 273, "PROGRAM.COPYCANVAS.DST_SCREEN # 0 1 0 112 ");
    rc_setStringArray(&rc_id, 274, "PROGRAM.COPYCANVAS.DST_X # 0 1 0 113 ");
    rc_setStringArray(&rc_id, 275, "PROGRAM.COPYCANVAS.DST_Y # 0 1 0 114 ");
    rc_setStringArray(&rc_id, 276, "PROGRAM.CLONECANVAS #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 277, "PROGRAM.CLONECANVAS.SRC_SCREEN # 0 1 0 115 ");
    rc_setStringArray(&rc_id, 278, "PROGRAM.CLONECANVAS.DST_SCREEN # 0 1 0 116 ");
    rc_setStringArray(&rc_id, 279, "PROGRAM.SETCANVASZ #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 280, "PROGRAM.SETCANVASZ.Z # 0 1 0 117 ");
    rc_setStringArray(&rc_id, 281, "PROGRAM.BOX #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 282, "PROGRAM.BOX.X1 # 0 1 0 118 ");
    rc_setStringArray(&rc_id, 283, "PROGRAM.BOX.Y1 # 0 1 0 119 ");
    rc_setStringArray(&rc_id, 284, "PROGRAM.BOX.X2 # 0 1 0 120 ");
    rc_setStringArray(&rc_id, 285, "PROGRAM.BOX.Y2 # 0 1 0 121 ");
    rc_setStringArray(&rc_id, 286, "PROGRAM.BOXFILL #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 287, "PROGRAM.BOXFILL.X1 # 0 1 0 122 ");
    rc_setStringArray(&rc_id, 288, "PROGRAM.BOXFILL.Y1 # 0 1 0 123 ");
    rc_setStringArray(&rc_id, 289, "PROGRAM.BOXFILL.X2 # 0 1 0 124 ");
    rc_setStringArray(&rc_id, 290, "PROGRAM.BOXFILL.Y2 # 0 1 0 125 ");
    rc_setStringArray(&rc_id, 291, "PROGRAM.CIRCLE #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 292, "PROGRAM.CIRCLE.X # 0 1 0 126 ");
    rc_setStringArray(&rc_id, 293, "PROGRAM.CIRCLE.Y # 0 1 0 127 ");
    rc_setStringArray(&rc_id, 294, "PROGRAM.CIRCLE.RADIUS # 0 1 0 128 ");
    rc_setStringArray(&rc_id, 295, "PROGRAM.CIRCLEFILL #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 296, "PROGRAM.CIRCLEFILL.X # 0 1 0 129 ");
    rc_setStringArray(&rc_id, 297, "PROGRAM.CIRCLEFILL.Y # 0 1 0 130 ");
    rc_setStringArray(&rc_id, 298, "PROGRAM.CIRCLEFILL.RADIUS # 0 1 0 131 ");
    rc_setStringArray(&rc_id, 299, "PROGRAM.ELLIPSE #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 300, "PROGRAM.ELLIPSE.X # 0 1 0 132 ");
    rc_setStringArray(&rc_id, 301, "PROGRAM.ELLIPSE.Y # 0 1 0 133 ");
    rc_setStringArray(&rc_id, 302, "PROGRAM.ELLIPSE.RADIUS_X # 0 1 0 134 ");
    rc_setStringArray(&rc_id, 303, "PROGRAM.ELLIPSE.RADIUS_Y # 0 1 0 135 ");
    rc_setStringArray(&rc_id, 304, "PROGRAM.ELLIPSEFILL #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 305, "PROGRAM.ELLIPSEFILL.X # 0 1 0 136 ");
    rc_setStringArray(&rc_id, 306, "PROGRAM.ELLIPSEFILL.Y # 0 1 0 137 ");
    rc_setStringArray(&rc_id, 307, "PROGRAM.ELLIPSEFILL.RADIUS_X # 0 1 0 138 ");
    rc_setStringArray(&rc_id, 308, "PROGRAM.ELLIPSEFILL.RADIUS_Y # 0 1 0 139 ");
    rc_setStringArray(&rc_id, 309, "PROGRAM.PIXEL #F 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 310, "PROGRAM.PIXEL.X # 0 1 0 140 ");
    rc_setStringArray(&rc_id, 311, "PROGRAM.PIXEL.Y # 0 1 0 141 ");
    rc_setStringArray(&rc_id, 312, "PROGRAM.SETCOLOR #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 313, "PROGRAM.SETCOLOR.COLOR # 0 1 0 142 ");
    rc_setStringArray(&rc_id, 314, "PROGRAM.LINE #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 315, "PROGRAM.LINE.X1 # 0 1 0 143 ");
    rc_setStringArray(&rc_id, 316, "PROGRAM.LINE.Y1 # 0 1 0 144 ");
    rc_setStringArray(&rc_id, 317, "PROGRAM.LINE.X2 # 0 1 0 145 ");
    rc_setStringArray(&rc_id, 318, "PROGRAM.LINE.Y2 # 0 1 0 146 ");
    rc_setStringArray(&rc_id, 319, "PROGRAM.FLOODFILL #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 320, "PROGRAM.FLOODFILL.X # 0 1 0 147 ");
    rc_setStringArray(&rc_id, 321, "PROGRAM.FLOODFILL.Y # 0 1 0 148 ");
    rc_setStringArray(&rc_id, 322, "PROGRAM.RGB #F 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 323, "PROGRAM.RGB.R # 0 1 0 149 ");
    rc_setStringArray(&rc_id, 324, "PROGRAM.RGB.G # 0 1 0 150 ");
    rc_setStringArray(&rc_id, 325, "PROGRAM.RGB.B # 0 1 0 151 ");
    rc_setStringArray(&rc_id, 326, "PROGRAM.RGBA #F 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 327, "PROGRAM.RGBA.R # 0 1 0 152 ");
    rc_setStringArray(&rc_id, 328, "PROGRAM.RGBA.G # 0 1 0 153 ");
    rc_setStringArray(&rc_id, 329, "PROGRAM.RGBA.B # 0 1 0 154 ");
    rc_setStringArray(&rc_id, 330, "PROGRAM.RGBA.A # 0 1 0 155 ");
    rc_setStringArray(&rc_id, 331, "PROGRAM.PSET #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 332, "PROGRAM.PSET.X # 0 1 0 156 ");
    rc_setStringArray(&rc_id, 333, "PROGRAM.PSET.Y # 0 1 0 157 ");
    rc_setStringArray(&rc_id, 334, "PROGRAM.CREATEIMAGE #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 335, "PROGRAM.CREATEIMAGE.SLOT # 0 1 0 158 ");
    rc_setStringArray(&rc_id, 336, "PROGRAM.CREATEIMAGE.W # 0 1 0 159 ");
    rc_setStringArray(&rc_id, 337, "PROGRAM.CREATEIMAGE.H # 0 1 0 160 ");
    rc_setStringArray(&rc_id, 338, "PROGRAM.CREATEIMAGE.PDATA #& 0 1 0 161 ");
    rc_setStringArray(&rc_id, 339, "PROGRAM.CREATEIMAGE_EX #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 340, "PROGRAM.CREATEIMAGE_EX.SLOT # 0 1 0 162 ");
    rc_setStringArray(&rc_id, 341, "PROGRAM.CREATEIMAGE_EX.W # 0 1 0 163 ");
    rc_setStringArray(&rc_id, 342, "PROGRAM.CREATEIMAGE_EX.H # 0 1 0 164 ");
    rc_setStringArray(&rc_id, 343, "PROGRAM.CREATEIMAGE_EX.PDATA #& 0 1 0 165 ");
    rc_setStringArray(&rc_id, 344, "PROGRAM.CREATEIMAGE_EX.COLKEY # 0 1 0 166 ");
    rc_setStringArray(&rc_id, 345, "PROGRAM.LOADIMAGE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 346, "PROGRAM.LOADIMAGE.SLOT # 0 1 0 167 ");
    rc_setStringArray(&rc_id, 347, "PROGRAM.LOADIMAGE.IMG_FILE$ $ 0 1 0 45 ");
    rc_setStringArray(&rc_id, 348, "PROGRAM.COLORKEY #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 349, "PROGRAM.COLORKEY.SLOT # 0 1 0 168 ");
    rc_setStringArray(&rc_id, 350, "PROGRAM.COLORKEY.COLOR # 0 1 0 169 ");
    rc_setStringArray(&rc_id, 351, "PROGRAM.COPYIMAGE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 352, "PROGRAM.COPYIMAGE.SRC_SLOT # 0 1 0 170 ");
    rc_setStringArray(&rc_id, 353, "PROGRAM.COPYIMAGE.DST_SLOT # 0 1 0 171 ");
    rc_setStringArray(&rc_id, 354, "PROGRAM.DELETEIMAGE #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 355, "PROGRAM.DELETEIMAGE.SLOT # 0 1 0 172 ");
    rc_setStringArray(&rc_id, 356, "PROGRAM.SETIMAGEALPHA #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 357, "PROGRAM.SETIMAGEALPHA.SLOT # 0 1 0 173 ");
    rc_setStringArray(&rc_id, 358, "PROGRAM.SETIMAGEALPHA.ALPHA # 0 1 0 174 ");
    rc_setStringArray(&rc_id, 359, "PROGRAM.GETIMAGEALPHA #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 360, "PROGRAM.GETIMAGEALPHA.SLOT # 0 1 0 175 ");
    rc_setStringArray(&rc_id, 361, "PROGRAM.GETIMAGEALPHA.ALPHA #& 0 1 0 176 ");
    rc_setStringArray(&rc_id, 362, "PROGRAM.GETIMAGESIZE #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 363, "PROGRAM.GETIMAGESIZE.SLOT # 0 1 0 177 ");
    rc_setStringArray(&rc_id, 364, "PROGRAM.GETIMAGESIZE.W #& 0 1 0 178 ");
    rc_setStringArray(&rc_id, 365, "PROGRAM.GETIMAGESIZE.H #& 0 1 0 179 ");
    rc_setStringArray(&rc_id, 366, "PROGRAM.FLIPIMAGE #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 367, "PROGRAM.FLIPIMAGE.SLOT # 0 1 0 180 ");
    rc_setStringArray(&rc_id, 368, "PROGRAM.FLIPIMAGE.FLIP_H # 0 1 0 181 ");
    rc_setStringArray(&rc_id, 369, "PROGRAM.FLIPIMAGE.FLIP_V # 0 1 0 182 ");
    rc_setStringArray(&rc_id, 370, "PROGRAM.DRAWIMAGE #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 371, "PROGRAM.DRAWIMAGE.SLOT # 0 1 0 183 ");
    rc_setStringArray(&rc_id, 372, "PROGRAM.DRAWIMAGE.X # 0 1 0 184 ");
    rc_setStringArray(&rc_id, 373, "PROGRAM.DRAWIMAGE.Y # 0 1 0 185 ");
    rc_setStringArray(&rc_id, 374, "PROGRAM.DRAWIMAGE_BLIT #P 0 1 7 0 0 ");
    rc_setStringArray(&rc_id, 375, "PROGRAM.DRAWIMAGE_BLIT.SLOT # 0 1 0 186 ");
    rc_setStringArray(&rc_id, 376, "PROGRAM.DRAWIMAGE_BLIT.X # 0 1 0 187 ");
    rc_setStringArray(&rc_id, 377, "PROGRAM.DRAWIMAGE_BLIT.Y # 0 1 0 188 ");
    rc_setStringArray(&rc_id, 378, "PROGRAM.DRAWIMAGE_BLIT.SRC_X # 0 1 0 189 ");
    rc_setStringArray(&rc_id, 379, "PROGRAM.DRAWIMAGE_BLIT.SRC_Y # 0 1 0 190 ");
    rc_setStringArray(&rc_id, 380, "PROGRAM.DRAWIMAGE_BLIT.SRC_W # 0 1 0 191 ");
    rc_setStringArray(&rc_id, 381, "PROGRAM.DRAWIMAGE_BLIT.SRC_H # 0 1 0 192 ");
    rc_setStringArray(&rc_id, 382, "PROGRAM.DRAWIMAGE_ROTATE #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 383, "PROGRAM.DRAWIMAGE_ROTATE.SLOT # 0 1 0 193 ");
    rc_setStringArray(&rc_id, 384, "PROGRAM.DRAWIMAGE_ROTATE.X # 0 1 0 194 ");
    rc_setStringArray(&rc_id, 385, "PROGRAM.DRAWIMAGE_ROTATE.Y # 0 1 0 195 ");
    rc_setStringArray(&rc_id, 386, "PROGRAM.DRAWIMAGE_ROTATE.ANGLE # 0 1 0 196 ");
    rc_setStringArray(&rc_id, 387, "PROGRAM.DRAWIMAGE_ROTATE_EX #P 0 1 8 0 0 ");
    rc_setStringArray(&rc_id, 388, "PROGRAM.DRAWIMAGE_ROTATE_EX.SLOT # 0 1 0 197 ");
    rc_setStringArray(&rc_id, 389, "PROGRAM.DRAWIMAGE_ROTATE_EX.X # 0 1 0 198 ");
    rc_setStringArray(&rc_id, 390, "PROGRAM.DRAWIMAGE_ROTATE_EX.Y # 0 1 0 199 ");
    rc_setStringArray(&rc_id, 391, "PROGRAM.DRAWIMAGE_ROTATE_EX.SRC_X # 0 1 0 200 ");
    rc_setStringArray(&rc_id, 392, "PROGRAM.DRAWIMAGE_ROTATE_EX.SRC_Y # 0 1 0 201 ");
    rc_setStringArray(&rc_id, 393, "PROGRAM.DRAWIMAGE_ROTATE_EX.SRC_W # 0 1 0 202 ");
    rc_setStringArray(&rc_id, 394, "PROGRAM.DRAWIMAGE_ROTATE_EX.SRC_H # 0 1 0 203 ");
    rc_setStringArray(&rc_id, 395, "PROGRAM.DRAWIMAGE_ROTATE_EX.ANGLE # 0 1 0 204 ");
    rc_setStringArray(&rc_id, 396, "PROGRAM.DRAWIMAGE_ZOOM #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 397, "PROGRAM.DRAWIMAGE_ZOOM.SLOT # 0 1 0 205 ");
    rc_setStringArray(&rc_id, 398, "PROGRAM.DRAWIMAGE_ZOOM.X # 0 1 0 206 ");
    rc_setStringArray(&rc_id, 399, "PROGRAM.DRAWIMAGE_ZOOM.Y # 0 1 0 207 ");
    rc_setStringArray(&rc_id, 400, "PROGRAM.DRAWIMAGE_ZOOM.ZOOM_X # 0 1 0 208 ");
    rc_setStringArray(&rc_id, 401, "PROGRAM.DRAWIMAGE_ZOOM.ZOOM_Y # 0 1 0 209 ");
    rc_setStringArray(&rc_id, 402, "PROGRAM.DRAWIMAGE_ZOOM_EX #P 0 1 9 0 0 ");
    rc_setStringArray(&rc_id, 403, "PROGRAM.DRAWIMAGE_ZOOM_EX.SLOT # 0 1 0 210 ");
    rc_setStringArray(&rc_id, 404, "PROGRAM.DRAWIMAGE_ZOOM_EX.X # 0 1 0 211 ");
    rc_setStringArray(&rc_id, 405, "PROGRAM.DRAWIMAGE_ZOOM_EX.Y # 0 1 0 212 ");
    rc_setStringArray(&rc_id, 406, "PROGRAM.DRAWIMAGE_ZOOM_EX.SRC_X # 0 1 0 213 ");
    rc_setStringArray(&rc_id, 407, "PROGRAM.DRAWIMAGE_ZOOM_EX.SRC_Y # 0 1 0 214 ");
    rc_setStringArray(&rc_id, 408, "PROGRAM.DRAWIMAGE_ZOOM_EX.SRC_W # 0 1 0 215 ");
    rc_setStringArray(&rc_id, 409, "PROGRAM.DRAWIMAGE_ZOOM_EX.SRC_H # 0 1 0 216 ");
    rc_setStringArray(&rc_id, 410, "PROGRAM.DRAWIMAGE_ZOOM_EX.ZOOM_X # 0 1 0 217 ");
    rc_setStringArray(&rc_id, 411, "PROGRAM.DRAWIMAGE_ZOOM_EX.ZOOM_Y # 0 1 0 218 ");
    rc_setStringArray(&rc_id, 412, "PROGRAM.DRAWIMAGE_ROTOZOOM #P 0 1 6 0 0 ");
    rc_setStringArray(&rc_id, 413, "PROGRAM.DRAWIMAGE_ROTOZOOM.SLOT # 0 1 0 219 ");
    rc_setStringArray(&rc_id, 414, "PROGRAM.DRAWIMAGE_ROTOZOOM.X # 0 1 0 220 ");
    rc_setStringArray(&rc_id, 415, "PROGRAM.DRAWIMAGE_ROTOZOOM.Y # 0 1 0 221 ");
    rc_setStringArray(&rc_id, 416, "PROGRAM.DRAWIMAGE_ROTOZOOM.ANGLE # 0 1 0 222 ");
    rc_setStringArray(&rc_id, 417, "PROGRAM.DRAWIMAGE_ROTOZOOM.ZOOM_X # 0 1 0 223 ");
    rc_setStringArray(&rc_id, 418, "PROGRAM.DRAWIMAGE_ROTOZOOM.ZOOM_Y # 0 1 0 224 ");
    rc_setStringArray(&rc_id, 419, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX #P 0 1 10 0 0 ");
    rc_setStringArray(&rc_id, 420, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.SLOT # 0 1 0 225 ");
    rc_setStringArray(&rc_id, 421, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.X # 0 1 0 226 ");
    rc_setStringArray(&rc_id, 422, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.Y # 0 1 0 227 ");
    rc_setStringArray(&rc_id, 423, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.SRC_X # 0 1 0 228 ");
    rc_setStringArray(&rc_id, 424, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.SRC_Y # 0 1 0 229 ");
    rc_setStringArray(&rc_id, 425, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.SRC_W # 0 1 0 230 ");
    rc_setStringArray(&rc_id, 426, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.SRC_H # 0 1 0 231 ");
    rc_setStringArray(&rc_id, 427, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.ANGLE # 0 1 0 232 ");
    rc_setStringArray(&rc_id, 428, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.ZOOM_X # 0 1 0 233 ");
    rc_setStringArray(&rc_id, 429, "PROGRAM.DRAWIMAGE_ROTOZOOM_EX.ZOOM_Y # 0 1 0 234 ");
    rc_setStringArray(&rc_id, 430, "PROGRAM.DRAWIMAGE_BLIT_EX #P 0 1 9 0 0 ");
    rc_setStringArray(&rc_id, 431, "PROGRAM.DRAWIMAGE_BLIT_EX.SLOT # 0 1 0 235 ");
    rc_setStringArray(&rc_id, 432, "PROGRAM.DRAWIMAGE_BLIT_EX.POS_X # 0 1 0 236 ");
    rc_setStringArray(&rc_id, 433, "PROGRAM.DRAWIMAGE_BLIT_EX.POS_Y # 0 1 0 237 ");
    rc_setStringArray(&rc_id, 434, "PROGRAM.DRAWIMAGE_BLIT_EX.POS_W # 0 1 0 238 ");
    rc_setStringArray(&rc_id, 435, "PROGRAM.DRAWIMAGE_BLIT_EX.POS_H # 0 1 0 239 ");
    rc_setStringArray(&rc_id, 436, "PROGRAM.DRAWIMAGE_BLIT_EX.SRC_X # 0 1 0 240 ");
    rc_setStringArray(&rc_id, 437, "PROGRAM.DRAWIMAGE_BLIT_EX.SRC_Y # 0 1 0 241 ");
    rc_setStringArray(&rc_id, 438, "PROGRAM.DRAWIMAGE_BLIT_EX.SRC_W # 0 1 0 242 ");
    rc_setStringArray(&rc_id, 439, "PROGRAM.DRAWIMAGE_BLIT_EX.SRC_H # 0 1 0 243 ");
    rc_setStringArray(&rc_id, 440, "PROGRAM.GETCURSOR #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 441, "PROGRAM.GETCURSOR.X #& 0 1 0 244 ");
    rc_setStringArray(&rc_id, 442, "PROGRAM.GETCURSOR.Y #& 0 1 0 245 ");
    rc_setStringArray(&rc_id, 443, "PROGRAM.PRINTS #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 444, "PROGRAM.PRINTS.TXT$ $ 0 1 0 46 ");
    rc_setStringArray(&rc_id, 445, "PROGRAM.INPUTS$ $F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 446, "PROGRAM.INPUTS$.PROMPT$ $ 0 1 0 47 ");
    rc_setStringArray(&rc_id, 447, "PROGRAM.LOCATE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 448, "PROGRAM.LOCATE.X # 0 1 0 246 ");
    rc_setStringArray(&rc_id, 449, "PROGRAM.LOCATE.Y # 0 1 0 247 ");
    rc_setStringArray(&rc_id, 450, "PROGRAM.FONTISLOADED #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 451, "PROGRAM.FONTISLOADED.F_SLOT # 0 1 0 248 ");
    rc_setStringArray(&rc_id, 452, "PROGRAM.FONT #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 453, "PROGRAM.FONT.F_SLOT # 0 1 0 249 ");
    rc_setStringArray(&rc_id, 454, "PROGRAM.LOADFONT #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 455, "PROGRAM.LOADFONT.F_SLOT # 0 1 0 250 ");
    rc_setStringArray(&rc_id, 456, "PROGRAM.LOADFONT.FNT_FILE$ $ 0 1 0 48 ");
    rc_setStringArray(&rc_id, 457, "PROGRAM.LOADFONT.SIZE # 0 1 0 251 ");
    rc_setStringArray(&rc_id, 458, "PROGRAM.DELETEFONT #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 459, "PROGRAM.DELETEFONT.F_SLOT # 0 1 0 252 ");
    rc_setStringArray(&rc_id, 460, "PROGRAM.SETFONTSTYLE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 461, "PROGRAM.SETFONTSTYLE.F_SLOT # 0 1 0 253 ");
    rc_setStringArray(&rc_id, 462, "PROGRAM.SETFONTSTYLE.STYLE # 0 1 0 254 ");
    rc_setStringArray(&rc_id, 463, "PROGRAM.DRAWTEXT #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 464, "PROGRAM.DRAWTEXT.TXT$ $ 0 1 0 49 ");
    rc_setStringArray(&rc_id, 465, "PROGRAM.DRAWTEXT.X # 0 1 0 255 ");
    rc_setStringArray(&rc_id, 466, "PROGRAM.DRAWTEXT.Y # 0 1 0 256 ");
    rc_setStringArray(&rc_id, 467, "PROGRAM.DRAWTEXT_SHADED #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 468, "PROGRAM.DRAWTEXT_SHADED.TXT$ $ 0 1 0 50 ");
    rc_setStringArray(&rc_id, 469, "PROGRAM.DRAWTEXT_SHADED.X # 0 1 0 257 ");
    rc_setStringArray(&rc_id, 470, "PROGRAM.DRAWTEXT_SHADED.Y # 0 1 0 258 ");
    rc_setStringArray(&rc_id, 471, "PROGRAM.DRAWTEXT_SHADED.FG_COLOR # 0 1 0 259 ");
    rc_setStringArray(&rc_id, 472, "PROGRAM.DRAWTEXT_SHADED.BG_COLOR # 0 1 0 260 ");
    rc_setStringArray(&rc_id, 473, "PROGRAM.DRAWTEXT_BLENDED #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 474, "PROGRAM.DRAWTEXT_BLENDED.TXT$ $ 0 1 0 51 ");
    rc_setStringArray(&rc_id, 475, "PROGRAM.DRAWTEXT_BLENDED.X # 0 1 0 261 ");
    rc_setStringArray(&rc_id, 476, "PROGRAM.DRAWTEXT_BLENDED.Y # 0 1 0 262 ");
    rc_setStringArray(&rc_id, 477, "PROGRAM.RENDERTEXT #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 478, "PROGRAM.RENDERTEXT.SLOT # 0 1 0 263 ");
    rc_setStringArray(&rc_id, 479, "PROGRAM.RENDERTEXT.TXT$ $ 0 1 0 52 ");
    rc_setStringArray(&rc_id, 480, "PROGRAM.GETTEXTSIZE #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 481, "PROGRAM.GETTEXTSIZE.F_SLOT # 0 1 0 264 ");
    rc_setStringArray(&rc_id, 482, "PROGRAM.GETTEXTSIZE.TXT$ $ 0 1 0 53 ");
    rc_setStringArray(&rc_id, 483, "PROGRAM.GETTEXTSIZE.W #& 0 1 0 265 ");
    rc_setStringArray(&rc_id, 484, "PROGRAM.GETTEXTSIZE.H #& 0 1 0 266 ");
    rc_setStringArray(&rc_id, 485, "PROGRAM.INKEY #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 486, "PROGRAM.KEY #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 487, "PROGRAM.KEY.KEY_CODE # 0 1 0 267 ");
    rc_setStringArray(&rc_id, 488, "PROGRAM.WAITKEY #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 489, "PROGRAM.HIDEMOUSE #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 490, "PROGRAM.SHOWMOUSE #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 491, "PROGRAM.MOUSEISVISIBLE #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 492, "PROGRAM.GETMOUSE #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 493, "PROGRAM.GETMOUSE.X #& 0 1 0 268 ");
    rc_setStringArray(&rc_id, 494, "PROGRAM.GETMOUSE.Y #& 0 1 0 269 ");
    rc_setStringArray(&rc_id, 495, "PROGRAM.GETMOUSE.MB1 #& 0 1 0 270 ");
    rc_setStringArray(&rc_id, 496, "PROGRAM.GETMOUSE.MB2 #& 0 1 0 271 ");
    rc_setStringArray(&rc_id, 497, "PROGRAM.GETMOUSE.MB3 #& 0 1 0 272 ");
    rc_setStringArray(&rc_id, 498, "PROGRAM.GETMOUSEWHEEL #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 499, "PROGRAM.GETMOUSEWHEEL.X_AXIS #& 0 1 0 273 ");
    rc_setStringArray(&rc_id, 500, "PROGRAM.GETMOUSEWHEEL.Y_AXIS #& 0 1 0 274 ");
    rc_setStringArray(&rc_id, 501, "PROGRAM.IMAGEEXISTS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 502, "PROGRAM.IMAGEEXISTS.SLOT # 0 1 0 275 ");
    rc_setStringArray(&rc_id, 503, "PROGRAM.NUMJOYSTICKS #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 504, "PROGRAM.JOYAXIS #F 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 505, "PROGRAM.JOYAXIS.JOY_NUM # 0 1 0 276 ");
    rc_setStringArray(&rc_id, 506, "PROGRAM.JOYAXIS.AXIS # 0 1 0 277 ");
    rc_setStringArray(&rc_id, 507, "PROGRAM.JOYBUTTON #F 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 508, "PROGRAM.JOYBUTTON.JOY_NUM # 0 1 0 278 ");
    rc_setStringArray(&rc_id, 509, "PROGRAM.JOYBUTTON.JOY_BUTTON # 0 1 0 279 ");
    rc_setStringArray(&rc_id, 510, "PROGRAM.JOYNAME$ $F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 511, "PROGRAM.JOYNAME$.JOY_NUM # 0 1 0 280 ");
    rc_setStringArray(&rc_id, 512, "PROGRAM.LOADSOUND #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 513, "PROGRAM.LOADSOUND.SLOT # 0 1 0 281 ");
    rc_setStringArray(&rc_id, 514, "PROGRAM.LOADSOUND.SOUND_FILE$ $ 0 1 0 54 ");
    rc_setStringArray(&rc_id, 515, "PROGRAM.LOADMUSIC #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 516, "PROGRAM.LOADMUSIC.MUSIC_FILE$ $ 0 1 0 55 ");
    rc_setStringArray(&rc_id, 517, "PROGRAM.PLAYSOUND #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 518, "PROGRAM.PLAYSOUND.SLOT # 0 1 0 282 ");
    rc_setStringArray(&rc_id, 519, "PROGRAM.PLAYSOUND.CHANNEL # 0 1 0 283 ");
    rc_setStringArray(&rc_id, 520, "PROGRAM.PLAYSOUND.LOOPS # 0 1 0 284 ");
    rc_setStringArray(&rc_id, 521, "PROGRAM.PLAYSOUNDTIMED #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 522, "PROGRAM.PLAYSOUNDTIMED.SLOT # 0 1 0 285 ");
    rc_setStringArray(&rc_id, 523, "PROGRAM.PLAYSOUNDTIMED.CHANNEL # 0 1 0 286 ");
    rc_setStringArray(&rc_id, 524, "PROGRAM.PLAYSOUNDTIMED.LOOPS # 0 1 0 287 ");
    rc_setStringArray(&rc_id, 525, "PROGRAM.PLAYSOUNDTIMED.MS # 0 1 0 288 ");
    rc_setStringArray(&rc_id, 526, "PROGRAM.PLAYMUSIC #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 527, "PROGRAM.PLAYMUSIC.LOOPS # 0 1 0 289 ");
    rc_setStringArray(&rc_id, 528, "PROGRAM.PAUSESOUND #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 529, "PROGRAM.PAUSESOUND.CHANNEL # 0 1 0 290 ");
    rc_setStringArray(&rc_id, 530, "PROGRAM.RESUMESOUND #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 531, "PROGRAM.RESUMESOUND.CHANNEL # 0 1 0 291 ");
    rc_setStringArray(&rc_id, 532, "PROGRAM.PAUSEMUSIC #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 533, "PROGRAM.RESUMEMUSIC #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 534, "PROGRAM.DELETESOUND #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 535, "PROGRAM.DELETESOUND.SLOT # 0 1 0 292 ");
    rc_setStringArray(&rc_id, 536, "PROGRAM.FADEMUSICIN #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 537, "PROGRAM.FADEMUSICIN.FADE_TIME # 0 1 0 293 ");
    rc_setStringArray(&rc_id, 538, "PROGRAM.FADEMUSICIN.LOOPS # 0 1 0 294 ");
    rc_setStringArray(&rc_id, 539, "PROGRAM.FADEMUSICOUT #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 540, "PROGRAM.FADEMUSICOUT.FADE_TIME # 0 1 0 295 ");
    rc_setStringArray(&rc_id, 541, "PROGRAM.MUSICEXISTS #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 542, "PROGRAM.SETMUSICVOLUME #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 543, "PROGRAM.SETMUSICVOLUME.VOLUME # 0 1 0 296 ");
    rc_setStringArray(&rc_id, 544, "PROGRAM.MUSICVOLUME #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 545, "PROGRAM.SETMUSICPOSITION #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 546, "PROGRAM.SETMUSICPOSITION.MUSIC_POS # 0 1 0 297 ");
    rc_setStringArray(&rc_id, 547, "PROGRAM.MUSICPOSITION #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 548, "PROGRAM.REWINDMUSIC #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 549, "PROGRAM.SETSOUNDCHANNELS #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 550, "PROGRAM.SETSOUNDCHANNELS.MAX_CHANNELS # 0 1 0 298 ");
    rc_setStringArray(&rc_id, 551, "PROGRAM.NUMSOUNDCHANNELS #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 552, "PROGRAM.SOUNDISENABLED #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 553, "PROGRAM.SOUNDEXISTS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 554, "PROGRAM.SOUNDEXISTS.SLOT # 0 1 0 299 ");
    rc_setStringArray(&rc_id, 555, "PROGRAM.SETCHANNELVOLUME #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 556, "PROGRAM.SETCHANNELVOLUME.CHANNEL # 0 1 0 300 ");
    rc_setStringArray(&rc_id, 557, "PROGRAM.SETCHANNELVOLUME.VOLUME # 0 1 0 301 ");
    rc_setStringArray(&rc_id, 558, "PROGRAM.CHANNELVOLUME #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 559, "PROGRAM.CHANNELVOLUME.CHANNEL # 0 1 0 302 ");
    rc_setStringArray(&rc_id, 560, "PROGRAM.SETSOUNDVOLUME #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 561, "PROGRAM.SETSOUNDVOLUME.SLOT # 0 1 0 303 ");
    rc_setStringArray(&rc_id, 562, "PROGRAM.SETSOUNDVOLUME.VOLUME # 0 1 0 304 ");
    rc_setStringArray(&rc_id, 563, "PROGRAM.SOUNDVOLUME #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 564, "PROGRAM.SOUNDVOLUME.SLOT # 0 1 0 305 ");
    rc_setStringArray(&rc_id, 565, "PROGRAM.STOPMUSIC #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 566, "PROGRAM.STOPSOUND #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 567, "PROGRAM.STOPSOUND.CHANNEL # 0 1 0 306 ");
    rc_setStringArray(&rc_id, 568, "PROGRAM.TCP_SOCKETOPEN #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 569, "PROGRAM.TCP_SOCKETOPEN.SOCKET # 0 1 0 307 ");
    rc_setStringArray(&rc_id, 570, "PROGRAM.TCP_SOCKETOPEN.HOST$ $ 0 1 0 56 ");
    rc_setStringArray(&rc_id, 571, "PROGRAM.TCP_SOCKETOPEN.PORT # 0 1 0 308 ");
    rc_setStringArray(&rc_id, 572, "PROGRAM.TCP_SOCKETCLOSE #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 573, "PROGRAM.TCP_SOCKETCLOSE.SOCKET # 0 1 0 309 ");
    rc_setStringArray(&rc_id, 574, "PROGRAM.TCP_REMOTEHOST #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 575, "PROGRAM.TCP_REMOTEHOST.SOCKET # 0 1 0 310 ");
    rc_setStringArray(&rc_id, 576, "PROGRAM.TCP_REMOTEPORT #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 577, "PROGRAM.TCP_REMOTEPORT.SOCKET # 0 1 0 311 ");
    rc_setStringArray(&rc_id, 578, "PROGRAM.TCP_GETDATA #F 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 579, "PROGRAM.TCP_GETDATA.SOCKET # 0 1 0 312 ");
    rc_setStringArray(&rc_id, 580, "PROGRAM.TCP_GETDATA.DST$ $& 0 1 0 57 ");
    rc_setStringArray(&rc_id, 581, "PROGRAM.TCP_GETDATA.NUMBYTES # 0 1 0 313 ");
    rc_setStringArray(&rc_id, 582, "PROGRAM.TCP_SENDDATA #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 583, "PROGRAM.TCP_SENDDATA.SOCKET # 0 1 0 314 ");
    rc_setStringArray(&rc_id, 584, "PROGRAM.TCP_SENDDATA.S_DATA$ $ 0 1 0 58 ");
    rc_setStringArray(&rc_id, 585, "PROGRAM.TCP_ACCEPTSOCKET #F 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 586, "PROGRAM.TCP_ACCEPTSOCKET.SOCKET_SERVER # 0 1 0 315 ");
    rc_setStringArray(&rc_id, 587, "PROGRAM.TCP_ACCEPTSOCKET.SOCKET_CLIENT # 0 1 0 316 ");
    rc_setStringArray(&rc_id, 588, "PROGRAM.UDP_SOCKETOPEN #F 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 589, "PROGRAM.UDP_SOCKETOPEN.SOCKET # 0 1 0 317 ");
    rc_setStringArray(&rc_id, 590, "PROGRAM.UDP_SOCKETOPEN.PORT # 0 1 0 318 ");
    rc_setStringArray(&rc_id, 591, "PROGRAM.UDP_GETDATA #F 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 592, "PROGRAM.UDP_GETDATA.SOCKET # 0 1 0 319 ");
    rc_setStringArray(&rc_id, 593, "PROGRAM.UDP_GETDATA.DST$ $& 0 1 0 59 ");
    rc_setStringArray(&rc_id, 594, "PROGRAM.UDP_GETDATA.HOST$ $& 0 1 0 60 ");
    rc_setStringArray(&rc_id, 595, "PROGRAM.UDP_GETDATA.PORT #& 0 1 0 320 ");
    rc_setStringArray(&rc_id, 596, "PROGRAM.UDP_LENGTH #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 597, "PROGRAM.UDP_MAXLENGTH #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 598, "PROGRAM.UDP_REMOTEHOST$ $F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 599, "PROGRAM.UDP_REMOTEHOST$.SOCKET # 0 1 0 321 ");
    rc_setStringArray(&rc_id, 600, "PROGRAM.UDP_REMOTEPORT #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 601, "PROGRAM.UDP_REMOTEPORT.SOCKET # 0 1 0 322 ");
    rc_setStringArray(&rc_id, 602, "PROGRAM.UDP_SOCKETCLOSE #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 603, "PROGRAM.UDP_SOCKETCLOSE.SOCKET # 0 1 0 323 ");
    rc_setStringArray(&rc_id, 604, "PROGRAM.UDP_SENDDATA #F 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 605, "PROGRAM.UDP_SENDDATA.SOCKET # 0 1 0 324 ");
    rc_setStringArray(&rc_id, 606, "PROGRAM.UDP_SENDDATA.S_DATA$ $ 0 1 0 61 ");
    rc_setStringArray(&rc_id, 607, "PROGRAM.UDP_SENDDATA.HOST$ $ 0 1 0 62 ");
    rc_setStringArray(&rc_id, 608, "PROGRAM.UDP_SENDDATA.PORT # 0 1 0 325 ");
    rc_setStringArray(&rc_id, 609, "PROGRAM.TOUCHPRESSURE #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 610, "PROGRAM.GETTOUCH #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 611, "PROGRAM.GETTOUCH.STATUS #& 0 1 0 326 ");
    rc_setStringArray(&rc_id, 612, "PROGRAM.GETTOUCH.X #& 0 1 0 327 ");
    rc_setStringArray(&rc_id, 613, "PROGRAM.GETTOUCH.Y #& 0 1 0 328 ");
    rc_setStringArray(&rc_id, 614, "PROGRAM.GETTOUCH.DX #& 0 1 0 329 ");
    rc_setStringArray(&rc_id, 615, "PROGRAM.GETTOUCH.DY #& 0 1 0 330 ");
    rc_setStringArray(&rc_id, 616, "PROGRAM.GETMULTITOUCH #P 0 1 6 0 0 ");
    rc_setStringArray(&rc_id, 617, "PROGRAM.GETMULTITOUCH.STATUS #& 0 1 0 331 ");
    rc_setStringArray(&rc_id, 618, "PROGRAM.GETMULTITOUCH.X #& 0 1 0 332 ");
    rc_setStringArray(&rc_id, 619, "PROGRAM.GETMULTITOUCH.Y #& 0 1 0 333 ");
    rc_setStringArray(&rc_id, 620, "PROGRAM.GETMULTITOUCH.NUMFINGERS #& 0 1 0 334 ");
    rc_setStringArray(&rc_id, 621, "PROGRAM.GETMULTITOUCH.DIST #& 0 1 0 335 ");
    rc_setStringArray(&rc_id, 622, "PROGRAM.GETMULTITOUCH.THETA #& 0 1 0 336 ");
    rc_setStringArray(&rc_id, 623, "PROGRAM.ZONEINPUT$ $F 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 624, "PROGRAM.ZONEINPUT$.X # 0 1 0 337 ");
    rc_setStringArray(&rc_id, 625, "PROGRAM.ZONEINPUT$.Y # 0 1 0 338 ");
    rc_setStringArray(&rc_id, 626, "PROGRAM.ZONEINPUT$.W # 0 1 0 339 ");
    rc_setStringArray(&rc_id, 627, "PROGRAM.ZONEINPUT$.H # 0 1 0 340 ");
    rc_setStringArray(&rc_id, 628, "PROGRAM.READINPUT_START #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 629, "PROGRAM.READINPUT_STOP #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 630, "PROGRAM.READINPUT_TEXT$ $F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 631, "PROGRAM.CANVASCLIP #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 632, "PROGRAM.CANVASCLIP.SLOT # 0 1 0 341 ");
    rc_setStringArray(&rc_id, 633, "PROGRAM.CANVASCLIP.SRC_X # 0 1 0 342 ");
    rc_setStringArray(&rc_id, 634, "PROGRAM.CANVASCLIP.SRC_Y # 0 1 0 343 ");
    rc_setStringArray(&rc_id, 635, "PROGRAM.CANVASCLIP.SRC_W # 0 1 0 344 ");
    rc_setStringArray(&rc_id, 636, "PROGRAM.CANVASCLIP.SRC_H # 0 1 0 345 ");
    rc_setStringArray(&rc_id, 637, "PROGRAM.WINDOWCLIP #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 638, "PROGRAM.WINDOWCLIP.SLOT # 0 1 0 346 ");
    rc_setStringArray(&rc_id, 639, "PROGRAM.WINDOWCLIP.SRC_X # 0 1 0 347 ");
    rc_setStringArray(&rc_id, 640, "PROGRAM.WINDOWCLIP.SRC_Y # 0 1 0 348 ");
    rc_setStringArray(&rc_id, 641, "PROGRAM.WINDOWCLIP.SRC_W # 0 1 0 349 ");
    rc_setStringArray(&rc_id, 642, "PROGRAM.WINDOWCLIP.SRC_H # 0 1 0 350 ");
    rc_setStringArray(&rc_id, 643, "PROGRAM.LOCALIP$ $F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 644, "PROGRAM.READINPUT_SETTEXT #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 645, "PROGRAM.READINPUT_SETTEXT.TXT$ $ 0 1 0 63 ");
    rc_setStringArray(&rc_id, 646, "PROGRAM.GETTOUCHFINGER #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 647, "PROGRAM.GETTOUCHFINGER.FINGER # 0 1 0 351 ");
    rc_setStringArray(&rc_id, 648, "PROGRAM.GETTOUCHFINGER.X #& 0 1 0 352 ");
    rc_setStringArray(&rc_id, 649, "PROGRAM.GETTOUCHFINGER.Y #& 0 1 0 353 ");
    rc_setStringArray(&rc_id, 650, "PROGRAM.GETTOUCHFINGER.PRESSURE #& 0 1 0 354 ");
    rc_setStringArray(&rc_id, 651, "PROGRAM.NUMFINGERS #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 652, "PROGRAM.LOADIMAGE_EX #P 0 1 3 0 0 ");
    rc_setStringArray(&rc_id, 653, "PROGRAM.LOADIMAGE_EX.SLOT # 0 1 0 355 ");
    rc_setStringArray(&rc_id, 654, "PROGRAM.LOADIMAGE_EX.IMG_FILE$ $ 0 1 0 64 ");
    rc_setStringArray(&rc_id, 655, "PROGRAM.LOADIMAGE_EX.COLKEY # 0 1 0 356 ");
    rc_setStringArray(&rc_id, 656, "PROGRAM.RECT #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 657, "PROGRAM.RECT.X # 0 1 0 357 ");
    rc_setStringArray(&rc_id, 658, "PROGRAM.RECT.Y # 0 1 0 358 ");
    rc_setStringArray(&rc_id, 659, "PROGRAM.RECT.W # 0 1 0 359 ");
    rc_setStringArray(&rc_id, 660, "PROGRAM.RECT.H # 0 1 0 360 ");
    rc_setStringArray(&rc_id, 661, "PROGRAM.RECTFILL #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 662, "PROGRAM.RECTFILL.X # 0 1 0 361 ");
    rc_setStringArray(&rc_id, 663, "PROGRAM.RECTFILL.Y # 0 1 0 362 ");
    rc_setStringArray(&rc_id, 664, "PROGRAM.RECTFILL.W # 0 1 0 363 ");
    rc_setStringArray(&rc_id, 665, "PROGRAM.RECTFILL.H # 0 1 0 364 ");
    rc_setStringArray(&rc_id, 666, "PROGRAM.OS$ $F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 667, "PROGRAM.NUMJOYBUTTONS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 668, "PROGRAM.NUMJOYBUTTONS.JOY_NUM # 0 1 0 365 ");
    rc_setStringArray(&rc_id, 669, "PROGRAM.NUMJOYAXES #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 670, "PROGRAM.NUMJOYAXES.JOY_NUM # 0 1 0 366 ");
    rc_setStringArray(&rc_id, 671, "PROGRAM.LOADVIDEO #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 672, "PROGRAM.LOADVIDEO.VID_FILE$ $ 0 1 0 65 ");
    rc_setStringArray(&rc_id, 673, "PROGRAM.PLAYVIDEO #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 674, "PROGRAM.PLAYVIDEO.VLOOPS # 0 1 0 367 ");
    rc_setStringArray(&rc_id, 675, "PROGRAM.PAUSEVIDEO #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 676, "PROGRAM.STOPVIDEO #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 677, "PROGRAM.SETVIDEOPOSITION #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 678, "PROGRAM.SETVIDEOPOSITION.VPOS # 0 1 0 368 ");
    rc_setStringArray(&rc_id, 679, "PROGRAM.RESUMEVIDEO #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 680, "PROGRAM.VIDEOPOSITION #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 681, "PROGRAM.DELETEVIDEO #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 682, "PROGRAM.DELETEMUSIC #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 683, "PROGRAM.SYSTEM #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 684, "PROGRAM.SYSTEM.SYS_CMD$ $ 0 1 0 66 ");
    rc_setStringArray(&rc_id, 685, "PROGRAM.VIDEOISPLAYING #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 686, "PROGRAM.ROUNDRECT #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 687, "PROGRAM.ROUNDRECT.X # 0 1 0 369 ");
    rc_setStringArray(&rc_id, 688, "PROGRAM.ROUNDRECT.Y # 0 1 0 370 ");
    rc_setStringArray(&rc_id, 689, "PROGRAM.ROUNDRECT.W # 0 1 0 371 ");
    rc_setStringArray(&rc_id, 690, "PROGRAM.ROUNDRECT.H # 0 1 0 372 ");
    rc_setStringArray(&rc_id, 691, "PROGRAM.ROUNDRECT.R # 0 1 0 373 ");
    rc_setStringArray(&rc_id, 692, "PROGRAM.ROUNDRECTFILL #P 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 693, "PROGRAM.ROUNDRECTFILL.X # 0 1 0 374 ");
    rc_setStringArray(&rc_id, 694, "PROGRAM.ROUNDRECTFILL.Y # 0 1 0 375 ");
    rc_setStringArray(&rc_id, 695, "PROGRAM.ROUNDRECTFILL.W # 0 1 0 376 ");
    rc_setStringArray(&rc_id, 696, "PROGRAM.ROUNDRECTFILL.H # 0 1 0 377 ");
    rc_setStringArray(&rc_id, 697, "PROGRAM.ROUNDRECTFILL.R # 0 1 0 378 ");
    rc_setStringArray(&rc_id, 698, "PROGRAM.VIDEOEND #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 699, "PROGRAM.GETVIDEOSTATS #F 0 1 5 0 0 ");
    rc_setStringArray(&rc_id, 700, "PROGRAM.GETVIDEOSTATS.VFILE$ $ 0 1 0 67 ");
    rc_setStringArray(&rc_id, 701, "PROGRAM.GETVIDEOSTATS.VLENGTH #& 0 1 0 379 ");
    rc_setStringArray(&rc_id, 702, "PROGRAM.GETVIDEOSTATS.VFPS #& 0 1 0 380 ");
    rc_setStringArray(&rc_id, 703, "PROGRAM.GETVIDEOSTATS.W #& 0 1 0 381 ");
    rc_setStringArray(&rc_id, 704, "PROGRAM.GETVIDEOSTATS.H #& 0 1 0 382 ");
    rc_setStringArray(&rc_id, 705, "PROGRAM.SETVIDEODRAWRECT #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 706, "PROGRAM.SETVIDEODRAWRECT.X # 0 1 0 383 ");
    rc_setStringArray(&rc_id, 707, "PROGRAM.SETVIDEODRAWRECT.Y # 0 1 0 384 ");
    rc_setStringArray(&rc_id, 708, "PROGRAM.SETVIDEODRAWRECT.W # 0 1 0 385 ");
    rc_setStringArray(&rc_id, 709, "PROGRAM.SETVIDEODRAWRECT.H # 0 1 0 386 ");
    rc_setStringArray(&rc_id, 710, "PROGRAM.GETVIDEODRAWRECT #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 711, "PROGRAM.GETVIDEODRAWRECT.X #& 0 1 0 387 ");
    rc_setStringArray(&rc_id, 712, "PROGRAM.GETVIDEODRAWRECT.Y #& 0 1 0 388 ");
    rc_setStringArray(&rc_id, 713, "PROGRAM.GETVIDEODRAWRECT.W #& 0 1 0 389 ");
    rc_setStringArray(&rc_id, 714, "PROGRAM.GETVIDEODRAWRECT.H #& 0 1 0 390 ");
    rc_setStringArray(&rc_id, 715, "PROGRAM.GETVIDEOSIZE #P 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 716, "PROGRAM.GETVIDEOSIZE.W #& 0 1 0 391 ");
    rc_setStringArray(&rc_id, 717, "PROGRAM.GETVIDEOSIZE.H #& 0 1 0 392 ");
    rc_setStringArray(&rc_id, 718, "PROGRAM.VIDEOEXISTS #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 719, "PROGRAM.SETVIDEOALPHA #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 720, "PROGRAM.SETVIDEOALPHA.V_ALPHA # 0 1 0 393 ");
    rc_setStringArray(&rc_id, 721, "PROGRAM.CREATESOUND #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 722, "PROGRAM.CREATESOUND.SLOT # 0 1 0 394 ");
    rc_setStringArray(&rc_id, 723, "PROGRAM.CREATESOUND.ABUF #& 0 1 0 395 ");
    rc_setStringArray(&rc_id, 724, "PROGRAM.CREATESOUND.ALEN # 0 1 0 396 ");
    rc_setStringArray(&rc_id, 725, "PROGRAM.CREATESOUND.AVOL # 0 1 0 397 ");
    rc_setStringArray(&rc_id, 726, "PROGRAM.COMMAND$ $F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 727, "PROGRAM.COMMAND$.ARG # 0 1 0 398 ");
    rc_setStringArray(&rc_id, 728, "PROGRAM.STR_F$ $F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 729, "PROGRAM.STR_F$.N # 0 1 0 399 ");
    rc_setStringArray(&rc_id, 730, "PROGRAM.STR_S$ $F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 731, "PROGRAM.STR_S$.N # 0 1 0 400 ");
    rc_setStringArray(&rc_id, 732, "PROGRAM.CLS #P 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 733, "PROGRAM.ENV$ $F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 734, "PROGRAM.ENV$.V$ $ 0 1 0 68 ");
    rc_setStringArray(&rc_id, 735, "PROGRAM.SETENV #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 736, "PROGRAM.SETENV.V$ $ 0 1 0 69 ");
    rc_setStringArray(&rc_id, 737, "PROGRAM.PREFPATH$ $F 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 738, "PROGRAM.PREFPATH$.ORG_NAME$ $ 0 1 0 70 ");
    rc_setStringArray(&rc_id, 739, "PROGRAM.PREFPATH$.APP_NAME$ $ 0 1 0 71 ");
    rc_setStringArray(&rc_id, 740, "PROGRAM.NUMJOYHATS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 741, "PROGRAM.NUMJOYHATS.JOY_NUM # 0 1 0 401 ");
    rc_setStringArray(&rc_id, 742, "PROGRAM.JOYHAT #F 0 1 2 0 0 ");
    rc_setStringArray(&rc_id, 743, "PROGRAM.JOYHAT.JOY_NUM # 0 1 0 402 ");
    rc_setStringArray(&rc_id, 744, "PROGRAM.JOYHAT.HAT # 0 1 0 403 ");
    rc_setStringArray(&rc_id, 745, "PROGRAM.NUMJOYTRACKBALLS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 746, "PROGRAM.NUMJOYTRACKBALLS.JOY_NUM # 0 1 0 404 ");
    rc_setStringArray(&rc_id, 747, "PROGRAM.GETJOYTRACKBALL #P 0 1 4 0 0 ");
    rc_setStringArray(&rc_id, 748, "PROGRAM.GETJOYTRACKBALL.JOY_NUM # 0 1 0 405 ");
    rc_setStringArray(&rc_id, 749, "PROGRAM.GETJOYTRACKBALL.BALL # 0 1 0 406 ");
    rc_setStringArray(&rc_id, 750, "PROGRAM.GETJOYTRACKBALL.DX #& 0 1 0 407 ");
    rc_setStringArray(&rc_id, 751, "PROGRAM.GETJOYTRACKBALL.DY #& 0 1 0 408 ");
    rc_setStringArray(&rc_id, 752, "PROGRAM.WINDOWHASINPUTFOCUS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 753, "PROGRAM.WINDOWHASINPUTFOCUS.WIN # 0 1 0 409 ");
    rc_setStringArray(&rc_id, 754, "PROGRAM.WINDOWHASMOUSEFOCUS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 755, "PROGRAM.WINDOWHASMOUSEFOCUS.WIN # 0 1 0 410 ");
    rc_setStringArray(&rc_id, 756, "PROGRAM.PUSH_N #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 757, "PROGRAM.PUSH_N.N # 0 1 0 411 ");
    rc_setStringArray(&rc_id, 758, "PROGRAM.PUSH_S #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 759, "PROGRAM.PUSH_S.S$ $ 0 1 0 72 ");
    rc_setStringArray(&rc_id, 760, "PROGRAM.POP_N #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 761, "PROGRAM.POP_S$ $F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 762, "PROGRAM.N_STACK_SIZE #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 763, "PROGRAM.S_STACK_SIZE #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 764, "PROGRAM.JOYSTICKISCONNECTED #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 765, "PROGRAM.JOYSTICKISCONNECTED.JOY_NUM # 0 1 0 412 ");
    rc_setStringArray(&rc_id, 766, "PROGRAM.NUMWINDOWS #F 0 1 0 0 0 ");
    rc_setStringArray(&rc_id, 767, "PROGRAM.WINDOWEXISTS #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 768, "PROGRAM.WINDOWEXISTS.WIN # 0 1 0 413 ");
    rc_setStringArray(&rc_id, 769, "PROGRAM.READINPUT_TOGGLEBACKSPACE #P 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 770, "PROGRAM.READINPUT_TOGGLEBACKSPACE.FLAG # 0 1 0 414 ");
    rc_setStringArray(&rc_id, 771, "PROGRAM.WINDOWEVENT_CLOSE #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 772, "PROGRAM.WINDOWEVENT_CLOSE.WIN # 0 1 0 415 ");
    rc_setStringArray(&rc_id, 773, "PROGRAM.WINDOWEVENT_MINIMIZE #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 774, "PROGRAM.WINDOWEVENT_MINIMIZE.WIN # 0 1 0 416 ");
    rc_setStringArray(&rc_id, 775, "PROGRAM.WINDOWEVENT_MAXIMIZE #F 0 1 1 0 0 ");
    rc_setStringArray(&rc_id, 776, "PROGRAM.WINDOWEVENT_MAXIMIZE.WIN # 0 1 0 417 ");
    ...
    {
        rc_id_str = rc_getStringArrayValue(rc_id, i);
        id = rc_id_str.substr(0,rc_id_str.find_first_of(" "));
...
void rc_debug()
{
//    cout << "rc_file = " << &rc_file << endl;
//    cout << "rc_tokens = " << rc_tokens << endl;
//    cout << "RC_DATA_SEGMENT = " << (uint64_t)(&RC_DATA_SEGMENT[0]) << endl;
//    cout << "RC_CODE_SEGMENT = " << (uint64_t)(&RC_CODE_SEGMENT[0]) << endl;
//    cout << "tmp = " << tmp << endl;
//    cout << "rc_preprocess = " << rc_preprocess << endl;
//    cout << "current_condition = " << current_condition << endl;
//    cout << "wcon_start = " << wcon_start << endl;
//    cout << "wcon_end = " << wcon_end << endl;
//    cout << "end_of_line = " << end_of_line << endl;
//    cout << "nid_byref_index = " << nid_byref_index << endl;
//    cout << "sid_byref_index = " << sid_byref_index << endl;
//    cout << "rc_keyword = " << rc_keyword << endl;
//    cout << "vm_str_args = " << vm_str_args << endl;
//    cout << "rc_label = " << &rc_label[0] << endl;
//    cout << "rc_label_u64 = " << (uint64_t)(&rc_label[0]) << endl;
...
//    return 0;
    //cout << "START\n";
    //tmp = rc_createStringArray(256, RC_TMP_ID);
    //tmp.inc_size = 128;

    rc_id = rc_createStringArray(10000, RC_ID_ID);
    char bleed[128];
    //rc_id.inc_size = 10000;

    //cout << "addr:" << (uint64_t)rc_id.str << endl; string s; cin >> s;

    //RC_CODE_SEGMENT = rc_createUCharArray(32767);
    //RC_CODE_SEGMENT.inc_size = 32767;

    //RC_DATA_SEGMENT = rc_createUCharArray(32767);
    //RC_DATA_SEGMENT.inc_size = 32767;
...
//        cout << i << " -> " << end_of_line[i] << endl;
    ...
    Uint32 tmp_size = 20000;

    int inc_i = 0;

    string rc_id_str = "";

    rc_asm_file.open("rcbasic.rc_asm", fstream::out | fstream::trunc);
    rc_data_bin.open("rcbasic_data.rc_bin", fstream::out | fstream::binary | fstream::trunc);

    cout << "Compiling RCBASIC Program" << endl << endl;
    while(true)
    {
        ...
        //s_line = " " + s_line;
        cout << line_number << " code_line:: " << s_line << endl;
        ...
        if(analyze_status!=0)
        {
            ...
            cout << "addr:" << (uint64_t) rc_id.str << endl;
            cout << "id = " << rc_id.id << endl;
            cout << "st_addr: " << rc_id_address << endl;
        ...
        for(int i = 0; i < tmp_count; i++)
        {
            rc_asm_file << rc_getStringArrayValue(tmp, i) << endl;
        }

        rc_clearStringArray(&tmp);
        tmp_count=0;
    }

    rc_asm_file << "end 0 " << endl;
    rc_asm_file.close();
    rc_data_bin.close();
    rc_file.close();

    fstream rc_data_file("rcbasic_data.data", fstream::out | fstream::trunc);

    rc_data_file << "nid_byref_count " << nid_byref_count << endl;
    rc_data_file << "sid_byref_count " << sid_byref_count << endl;

    for(int i = 0; i < nid_byref_count; i++)
    {
        rc_data_file << "nid_byref " << nid_byref_index[i] << endl;
    }

    for(int i = 0; i < sid_byref_count; i++)
    {
        rc_data_file << "sid_byref " << sid_byref_index[i] << endl;
    }

    rc_data_file << "nid_count " << nid_count << endl;
    rc_data_file << "sid_count " << sid_count << endl;
    rc_data_file << "max_m " << max_m << endl;
    rc_data_file << "max_s " << max_s << endl;
    rc_data_file << "max_f " << max_f << endl;
    rc_data_file << "num_stack " << num_stack_size << endl;
    rc_data_file << "str_stack " << str_stack_size << endl;


    for(int i = 0; i < rc_id_count; i++)
    {
        rc_data_file << rc_getStringArrayValue(rc_id, i) << endl;
    }
